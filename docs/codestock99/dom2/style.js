...
{var fontSizeOf = new constructFontSizeOf (h1, h2, h3, h4, h5, h6, titlepage, p, li, ul, ol, dl, dt, dd, blockquote, th, td, pre, tt, small, medium, large, sizeMultiplier, minFontSize)
 if (is.nav5up) {
   /* HACK: this works but isn't ideal */
   var styleSheetElement = getStyleSheetByTitle (styleSheetTitle);
   /* BUG? Should be this:
   var styleSheetElement = document.getElementsByID(ieTargetStyleSheetID);
   */
   // .3em matches Nav4 behavior; do .25em to save space for Notification bar
   var m7LayoutHack = "; margin-top: 0px; margin-bottom: 0.25em; ";
   var m7LILayoutHack = "; margin-top: 0px; margin-bottom: 0em; ";
   // var m7LayoutHack = "";
   addRuleToStyleElement (styleSheetElement, "H1", "font-size:" + fontSizeOf.h1 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "H2", "font-size:" + fontSizeOf.h2 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "H3", "font-size:" + fontSizeOf.h3 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "H4", "font-size:" + fontSizeOf.h4 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "H5", "font-size:" + fontSizeOf.h5 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "H6", "font-size:" + fontSizeOf.h6 + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "PRE", "font-size:" + fontSizeOf.pre + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "P", "font-size:" + fontSizeOf.p + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "LI", "font-size:" + fontSizeOf.li + m7LILayoutHack);
   addRuleToStyleElement (styleSheetElement, "UL", "font-size:" + fontSizeOf.ul + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "OL", "font-size:" + fontSizeOf.ol + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "DL", "font-size:" + fontSizeOf.dl + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "DT", "font-size:" + fontSizeOf.dt + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "DD", "font-size:" + fontSizeOf.dd + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "BLOCKQUOTE", "font-size:" + fontSizeOf.blockquote + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "TH", "font-size:" + fontSizeOf.th + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, "TD", "font-size:" + fontSizeOf.td + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, ".titlepage", "font-size:" + fontSizeOf.titlepage + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, ".small",  "font-size:" + fontSizeOf.small + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, ".medium", "font-size:" + fontSizeOf.medium + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, ".large", "font-size:" + fontSizeOf.large + m7LayoutHack);
   addRuleToStyleElement (styleSheetElement, ".footnote", "font-size:" + fontSizeOf.small + m7LayoutHack);
 }
 else if (is.nav4) {
