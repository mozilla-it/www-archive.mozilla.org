...
ResDef(MK_MSG_NEWS_MESSAGE_NO_COPY_TO_IMAP,    -473,
...
"Unable to import certificates.  Navigator only supports password\n\
...
contents is not supported by Navigator.")
#else
ResDef(SEC_ERROR_PKCS12_UNSUPPORTED_PBE_ALGORITHM, 	(SEC_ERROR_BASE + 83),
"Unable to import certificates.  The algorithm used to encrypt the\n\
...
as one being imported already exists in your Navigator database.")
#else
ResDef(SEC_ERROR_PKCS12_CERT_COLLISION,		(SEC_ERROR_BASE + 86),
"Unable to import certificates.  A certificate with the same nickname,\n\
...
ResDef(SEC_ERROR_KRL_NOT_YET_VALID,  (SEC_ERROR_BASE + 112),
"The key revocation list for this site's certificate\n\
is not yet valid.  Reload a new key revocation list.")

ResDef(SEC_ERROR_CRL_NOT_YET_VALID,  (SEC_ERROR_BASE + 113),
...
<head>%-styleinfo-%</head><body bgcolor=\042#bbbbbb\042>\
<div><form name=theform \
...
</font></form></div></body>%0%")


ResDef(XP_DIALOG_JS_HEADER_STRINGS, (SEC_DIALOG_STRING_BASE + 8), "\
<HTML><HEAD>%-styleinfo-%<TITLE>%0%</TITLE><SCRIPT LANGUAGE=\042JavaScript\042>\nvar dlgstring ='")

ResDef(XP_DIALOG_JS_MIDDLE_STRINGS, (SEC_DIALOG_STRING_BASE + 9), "\
';\nvar butstring ='")

ResDef(XP_DIALOG_JS_FOOTER_STRINGS, (SEC_DIALOG_STRING_BASE + 10), "\
';\nfunction drawdlg(win){\ncaptureEvents(Event.MOUSEDOWN);\n\
with(win.frames[0]) {\ndocument.write(parent.dlgstring);document.close();\n}\n\
with(win.frames[1]) {\nbutstring='<html><body bgcolor=\042#bbbbbb\042><form>'\
%-cont-%")

ResDef(XP_DIALOG_JS_FOOTER_STRINGS2, (SEC_DIALOG_STRING_BASE + 11), "\
...
ResDef(XP_DIALOG_JS_FOOTER_STRINGS3, (SEC_DIALOG_STRING_BASE + 12), "\
submit();\n}\n}\nfunction onMouseDown(e)\n{\nif ( e.which == 3 )\n\
return false;\nreturn true;\n}\n</SCRIPT></HEAD><FRAMESET ROWS=\042*,50\042\
ONLOAD=\042drawdlg(window)\042 BORDER=0>\n%-cont-%")

ResDef(XP_DIALOG_JS_FOOTER_STRINGS4, (SEC_DIALOG_STRING_BASE + 13), "\
...
ResDef(XP_DIALOG_CANCEL_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 14), "\
...
ResDef(XP_DIALOG_OK_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 15), "\
...
ResDef(XP_DIALOG_CONTINUE_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 16), "\
...
ResDef(XP_DIALOG_CANCEL_CONTINUE_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 18), "\
...
ResDef(XP_PANEL_HEADER_STRINGS, (SEC_DIALOG_STRING_BASE + 19), "\
<head>%-styleinfo-%</head><body bgcolor=\042#bbbbbb\042><form name=theform \
action=internal-panel-handler method=post><input type=\042hidden\042 \
%-cont-%")

ResDef(XP_PANEL_HEADER_STRINGS_1, (SEC_DIALOG_STRING_BASE + 20), "\
name=\042handle\042 value=\042%0%\042><input type=\042hidden\042 name=\042xxxbuttonxxx\042>\
<font size=2>")

ResDef(XP_PANEL_FIRST_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 26), "\
...
ResDef(XP_PANEL_FIRST_BUTTON_STRINGS_1, (SEC_DIALOG_STRING_BASE + 27), "\
type=\042button\042 name=\042button\042 value=\042%cancel%\042 onclick=\042parent.clicker(this,window.parent)\042 width=80></div>%0%")

ResDef(XP_PANEL_MIDDLE_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 28), "\
<div align=right><input type=\042button\042 name=\042button\042 \
...
ResDef(XP_PANEL_MIDDLE_BUTTON_STRINGS_1, (SEC_DIALOG_STRING_BASE + 29), "\
...
ResDef(XP_PANEL_LAST_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 30), "\
<dig align=right><input type=\042button\042 name=\042button\042 \
value=\042%back%\042 onclick=\042parent.clicker(this,window.parent)\042 \
width=80>%-cont-%")

ResDef(XP_PANEL_LAST_BUTTON_STRINGS_1, (SEC_DIALOG_STRING_BASE + 31), "\
<input type=\042button\042 name=\042button\042 value=\042%finished%\042 \
onclick=\042parent.clicker(this,window.parent)\042 width=80>&nbsp;&nbsp;\
<input type=\042button\042 name=\042button\042 value=\042%cancel%\042 \
onclick=\042parent.clicker(this,window.parent)\042 width=80></div>%0%")

ResDef(XP_PLAIN_CERT_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 32), "\
%0%")

ResDef(XP_CERT_CONFIRM_STRINGS, (SEC_DIALOG_STRING_BASE + 33), "\
<title>%0%</title><b>%1%</b><hr>%2%<hr>%3%")

ResDef(XP_CERT_PAGE_STRINGS, (SEC_DIALOG_STRING_BASE + 34), "\
%0%%1%%2%")

ResDef(XP_SSL_SERVER_CERT1_STRINGS, (SEC_DIALOG_STRING_BASE + 35), "\
%sec-banner-begin%%0%%sec-banner-end%\
<b><font size=4>\
%1% is a site that uses encryption to protect transmitted information. \
%-cont-%")

ResDef(XP_SSL_SERVER_CERT1_STRINGS_1, (SEC_DIALOG_STRING_BASE + 36), "\
...
ResDef(XP_SSL_SERVER_CERT1_STRINGS_2, (SEC_DIALOG_STRING_BASE + 37), "\
...
ResDef(XP_SSL_SERVER_CERT2_STRINGS_3, (SEC_DIALOG_STRING_BASE + 47), "\
...
ResDef(XP_SSL_SERVER_CERT2_STRINGS_4, (SEC_DIALOG_STRING_BASE + 48), "\
would be for someone to eavesdrop on any information exchanged between \
you and this web site.%6%")

ResDef(XP_SSL_SERVER_CERT3_STRINGS, (SEC_DIALOG_STRING_BASE + 49), "\
%sec-banner-begin%%0%%sec-banner-end%\
Are you willing \
to accept this certificate for the purposes of receiving encrypted \
%-cont-%")

ResDef(XP_SSL_SERVER_CERT3_STRINGS_1, (SEC_DIALOG_STRING_BASE + 50), "\
...
ResDef(XP_SSL_SERVER_CERT3_STRINGS_2, (SEC_DIALOG_STRING_BASE + 51), "\
...
ResDef(XP_SSL_SERVER_CERT3_STRINGS_3, (SEC_DIALOG_STRING_BASE + 52), "\
...
ResDef(XP_SSL_SERVER_CERT3_STRINGS_4, (SEC_DIALOG_STRING_BASE + 53), "\
value=forever%3%>Accept this certificate forever (until it expires)<br>\
%4%")
ResDef(XP_SSL_SERVER_CERT4_STRINGS, (SEC_DIALOG_STRING_BASE + 64), "\
%sec-banner-begin%%0%%sec-banner-end%\
By accepting this \
certificate you are ensuring that all information you exchange with this site \
%-cont-%")

ResDef(XP_SSL_SERVER_CERT4_STRINGS_1, (SEC_DIALOG_STRING_BASE + 65), "\
...
ResDef(XP_SSL_SERVER_CERT4_STRINGS_2, (SEC_DIALOG_STRING_BASE + 66), "(\
...
ResDef(XP_SSL_SERVER_CERT4_STRINGS_3, (SEC_DIALOG_STRING_BASE + 67), "\
...
ResDef(XP_SSL_SERVER_CERT4_STRINGS_4, (SEC_DIALOG_STRING_BASE + 68), "\
before I send information to this site</center><p>%2%")

ResDef(XP_SSL_SERVER_CERT5A_STRINGS, (SEC_DIALOG_STRING_BASE + 69), "\
%sec-banner-begin%%0%%sec-banner-end%\
<b>You have \
finished examining the certificate presented by:<br>%1%</b><p>You have \
%-cont-%")

ResDef(XP_SSL_SERVER_CERT5A_STRINGS_1, (SEC_DIALOG_STRING_BASE + 70), "\
...
ResDef(XP_SSL_SERVER_CERT5A_STRINGS_2, (SEC_DIALOG_STRING_BASE + 71), "\
...
ResDef(XP_SSL_SERVER_CERT5B_STRINGS, (SEC_DIALOG_STRING_BASE + 72), "\
%sec-banner-begin%%0%%sec-banner-end%\
<b>You have \
finished examining the certificate presented by:<br>%1%</b><p>You have \
%-cont-%")
...
#ifdef MOZ_LITE
ResDef(XP_SSL_SERVER_CERT5B_STRINGS_1, (SEC_DIALOG_STRING_BASE + 73), "\
decided to accept this certificate and have asked that Netscape Navigator warn \
...
#ifdef MOZ_LITE
ResDef(XP_SSL_SERVER_CERT5B_STRINGS_2, (SEC_DIALOG_STRING_BASE + 74), "\
change your mind, open Security Info from the Navigator menu and edit \
...
ResDef(XP_SSL_SERVER_CERT5C_STRINGS, (SEC_DIALOG_STRING_BASE + 80), "\
%sec-banner-begin%%0%%sec-banner-end%\
<b>You have \
finished examining the certificate presented by:<br>%1%</b><p>You have \
%-cont-%")
...
#ifdef MOZ_LITE
ResDef(XP_SSL_SERVER_CERT5C_STRINGS_1, (SEC_DIALOG_STRING_BASE + 81), "\
decided to accept this certificate and have decided not to have Netscape \
Navigator warn you before you send information to this site.<p>If \
%-cont-%")
#else
ResDef(XP_SSL_SERVER_CERT5C_STRINGS_1, (SEC_DIALOG_STRING_BASE + 81), "\
decided to accept this certificate and have decided not to have Netscape \
...
#ifdef MOZ_LITE
ResDef(XP_SSL_SERVER_CERT5C_STRINGS_2, (SEC_DIALOG_STRING_BASE + 82), "\
you change your mind, open Security Info from the Navigator Menu \
...
ResDef(XP_SSL_SERVER_CERT5C_STRINGS_3, (SEC_DIALOG_STRING_BASE + 83), "\
receiving documents.%2%")

ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 84), "\
%sec-banner-begin%%0%%sec-banner-end%\
The certificate \
that the site '%1%' has presented does not contain the correct site \
%-cont-%")

ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 85), "\
...
ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 86), "\
...
ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 87), "\
...
ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS_4, (SEC_DIALOG_STRING_BASE + 88), "\
</font></td><td valign=top><font size=2>%2%<br>%3%<br>%4% Grade (%5% \
with %6%-bit secret key)</font></td><td valign=bottom><input \
%-cont-%")

ResDef(XP_SSL_CERT_DOMAIN_DIALOG_STRINGS_5, (SEC_DIALOG_STRING_BASE + 89), "\
type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042></td></tr></table>\
<hr>%7%")
ResDef(XP_PW_ENTER_NEW_STRINGS, (SEC_DIALOG_STRING_BASE + 100), "\
%sec-banner-begin%%0%%sec-banner-end%\
Please enter your new password.  The safest passwords are a combination \
of letters \
%-cont-%")

ResDef(XP_PW_ENTER_NEW_STRINGS_1, (SEC_DIALOG_STRING_BASE + 101), "\
...
ResDef(XP_PW_ENTER_NEW_STRINGS_2, (SEC_DIALOG_STRING_BASE + 102), "\
...
ResDef(XP_PW_ENTER_NEW_STRINGS_3, (SEC_DIALOG_STRING_BASE + 103), "\
password cannot be recovered. If you forget it, you will have to obtain \
new Certificates.</b>")

ResDef(XP_PW_RETRY_NEW_STRINGS, (SEC_DIALOG_STRING_BASE + 109), "\
%sec-banner-begin%%0%%sec-banner-end%\
You did not \
enter your password correctly.  Please try again:<p>Password: <input \
%-cont-%")

ResDef(XP_PW_RETRY_NEW_STRINGS_1, (SEC_DIALOG_STRING_BASE + 110), "\
...
ResDef(XP_PW_RETRY_NEW_STRINGS_2, (SEC_DIALOG_STRING_BASE + 111), "\
...
ResDef(XP_PW_SETUP_STRINGS, (SEC_DIALOG_STRING_BASE + 112), "\
%sec-banner-begin%%0%%sec-banner-end%\
It is strongly recommended that you protect your Private Key with a \
%-cont-%")

#ifdef MOZ_LITE
ResDef(XP_PW_SETUP_STRINGS_1, (SEC_DIALOG_STRING_BASE + 113), "\
Navigator password.  If you do not want a password, leave the password \
...
ResDef(XP_PW_SETUP_STRINGS_2, (SEC_DIALOG_STRING_BASE + 114), "\
...
#ifdef MOZ_LITE
ResDef(XP_PW_SETUP_STRINGS_5, (SEC_DIALOG_STRING_BASE + 117), "\
preferences, choose Security Info from the Navigator menu.")
#else
ResDef(XP_PW_SETUP_STRINGS_5, (SEC_DIALOG_STRING_BASE + 117), "\
...
ResDef(XP_PW_SETUP_REFUSED_STRINGS, (SEC_DIALOG_STRING_BASE + 128), "\
%sec-banner-begin%%0%%sec-banner-end%\
You have elected to operate without a password.<p>If you decide that you \
%-cont-%")

ResDef(XP_PW_SETUP_REFUSED_STRINGS_1, (SEC_DIALOG_STRING_BASE + 129), "\
...
ResDef(XP_PW_CHANGE_STRINGS,		(SEC_DIALOG_STRING_BASE + 130), "\
%sec-banner-begin%%0%%sec-banner-end%\
Change the password for the %1%.<p>Enter your old password: <input \
%-cont-%")

ResDef(XP_PW_CHANGE_STRINGS_1,		(SEC_DIALOG_STRING_BASE + 131), "\
...
ResDef(XP_PW_CHANGE_STRINGS_2,		(SEC_DIALOG_STRING_BASE + 132), "\
...
ResDef(XP_PW_CHANGE_STRINGS_3,		(SEC_DIALOG_STRING_BASE + 133), "\
</td></tr></table><p><B>Important: Your password cannot be recovered.  If \
you forget it, you will lose all of your certificates.</B>")


ResDef(XP_PW_CHANGE_FAILURE_STRINGS,	(SEC_DIALOG_STRING_BASE + 140), "\
%sec-banner-begin%%0%%sec-banner-end%\
Your attempt to change your password failed.<p>This may be because your \
%-cont-%")

#ifdef MOZ_LITE
ResDef(XP_PW_CHANGE_FAILURE_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 141), "\
key database is inaccessible (which can happen if you were already \
running a Navigator when you started this one), or because of some other \
%-cont-%")
#else
ResDef(XP_PW_CHANGE_FAILURE_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 141), "\
key database is inaccessible (which can happen if you were already \
...
ResDef(XP_PW_CHANGE_FAILURE_STRINGS_2,	(SEC_DIALOG_STRING_BASE + 142), "\
...
ResDef(XP_PW_CHANGE_FAILURE_STRINGS_3,	(SEC_DIALOG_STRING_BASE + 143), "\
...
ResDef(XP_DIALOG_CANCEL_OK_MOREINFO_BUTTON_STRINGS_2, 
	(SEC_DIALOG_STRING_BASE + 196),"\
<input type=\042button\042 value=\042%cancel%\042 width=80 \
onclick=\042parent.clicker(this,window.parent)\042></td></table>")



ResDef(XP_PANEL_ONLY_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 199), "\
<div align=right><input type=\042button\042 name=\042button\042 \
value=\042%finished%\042 onclick=\042parent.clicker(this,window.parent)\042 \
width=80>&nbsp;&nbsp;\
%-cont-%")

ResDef(XP_PANEL_ONLY_BUTTON_STRINGS_1, (SEC_DIALOG_STRING_BASE + 200), "\
...
ResDef(XP_NOT_IMPLEMENTED_STRINGS, (SEC_DIALOG_STRING_BASE + 211), "\
%sec-banner-begin%%0%%sec-banner-end%\
This function is \
not implemented:<br>%1%<br>Certificate name:<br>%2%")

ResDef(XP_CERT_VIEW_STRINGS, (SEC_DIALOG_STRING_BASE + 212), "\
%0%%1%")

ResDef(XP_DELETE_USER_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 213), "\
...
ResDef(XP_DELETE_SITE_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 214), "\
Are you sure that you want to delete this Site Certificate?<p>%0%")

ResDef(XP_DELETE_CA_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 215), "\
Are you sure that you want to delete this Certificate Authority?<p>%0%")

ResDef(XP_EDIT_SITE_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 216), "\
...
ResDef(XP_EDIT_SITE_CERT_STRINGS_1, (SEC_DIALOG_STRING_BASE + 217), "\
...
ResDef(XP_EDIT_SITE_CERT_STRINGS_2, (SEC_DIALOG_STRING_BASE + 218), "\
before sending data to this site")

ResDef(XP_EDIT_CA_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 224), "\
%0%<hr><div>This Certificate belongs to a Certifying Authority<br> \
%-cont-%")

ResDef(XP_EDIT_CA_CERT_STRINGS_1, (SEC_DIALOG_STRING_BASE + 225), "\
%1%<br>%2%<br>%3%<hr><input \
%-cont-%")

ResDef(XP_EDIT_CA_CERT_STRINGS_2, (SEC_DIALOG_STRING_BASE + 226), "\
type=checkbox name=postwarn value=yes %4%>Warn before sending data to \
sites certified by this authority</div>")

ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 232), "\
%sec-banner-begin%%0%%sec-banner-end%\
<b>Warning: You \
%-cont-%")

ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 233), "\
...
ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 234), "\
...
ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 235), "\
<table><tr><td valign=top><font size=2>Certificate for: <br>Signed by: \
<br>Encryption: </font></td><td valign=top><font size=2>%2%<br>%3%<br>\
%-cont-%")

ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_4, (SEC_DIALOG_STRING_BASE + 236), "\
...
ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_5, (SEC_DIALOG_STRING_BASE + 237), "\
\042></font></td></tr></table><hr><input type=radio name=action \
value=sendandwarn checked>Send this information and warn again next \
%-cont-%")

ResDef(XP_SSL_CERT_POST_WARN_DIALOG_STRINGS_6, (SEC_DIALOG_STRING_BASE + 238), "\
...
ResDef(XP_CA_CERT_DOWNLOAD1_STRINGS, (SEC_DIALOG_STRING_BASE + 239), "\
%sec-banner-begin%%0%%sec-banner-end%\
You are about to \
%-cont-%")

ResDef(XP_CA_CERT_DOWNLOAD1_STRINGS_1, (SEC_DIALOG_STRING_BASE + 240), "\
...
ResDef(XP_CA_CERT_DOWNLOAD1_STRINGS_2, (SEC_DIALOG_STRING_BASE + 241), "\
Netscape. This assistant will help you decide whether or not you wish to \
accept this Certificate Authority.")
ResDef(XP_CA_CERT_DOWNLOAD2_STRINGS, (SEC_DIALOG_STRING_BASE + 252), "\
%sec-banner-begin%%0%%sec-banner-end%\
A Certificate \
%-cont-%")

#ifdef MOZ_LITE
ResDef(XP_CA_CERT_DOWNLOAD2_STRINGS_1, (SEC_DIALOG_STRING_BASE + 253), "\
Authority certifies the identity of sites on the internet. By accepting \
this Certificate Authority, you will allow Netscape Navigator to connect \
%-cont-%")
#else
ResDef(XP_CA_CERT_DOWNLOAD2_STRINGS_1, (SEC_DIALOG_STRING_BASE + 253), "\
Authority certifies the identity of sites on the internet. By accepting \
...
ResDef(XP_CA_CERT_DOWNLOAD2_STRINGS_2, (SEC_DIALOG_STRING_BASE + 254), "\
...
ResDef(XP_CA_CERT_DOWNLOAD2_STRINGS_3, (SEC_DIALOG_STRING_BASE + 255), "\
...
ResDef(XP_CA_CERT_DOWNLOAD3_STRINGS, (SEC_DIALOG_STRING_BASE + 261), "\
%sec-banner-begin%%0%%sec-banner-end%\
Here is the \
certificate for this Certificate Authority. Examine it carefully. The \
%-cont-%")

ResDef(XP_CA_CERT_DOWNLOAD3_STRINGS_1, (SEC_DIALOG_STRING_BASE + 262), "\
...
ResDef(XP_CA_CERT_DOWNLOAD3_STRINGS_2, (SEC_DIALOG_STRING_BASE + 263), "\
...
ResDef(XP_CA_CERT_DOWNLOAD3_STRINGS_3, (SEC_DIALOG_STRING_BASE + 264), "\
<td valign=top><font size=2>%1%<br>%2%</font></td><td valign=bottom>\
<font size=2><input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\
%-cont-%")

ResDef(XP_CA_CERT_DOWNLOAD3_STRINGS_4, (SEC_DIALOG_STRING_BASE + 265), "\
\042></font></td></tr></table><hr>")

ResDef(XP_CA_CERT_DOWNLOAD4_STRINGS, (SEC_DIALOG_STRING_BASE + 266), "\
%sec-banner-begin%%0%%sec-banner-end%\
Are you willing \
to accept this Certificate Authority for the purposes of certifying \
%-cont-%")

ResDef(XP_CA_CERT_DOWNLOAD4_STRINGS_1, (SEC_DIALOG_STRING_BASE + 267), "\
other internet sites, email users, or software developers?<p> \
%1%%2%%3%")

#ifdef MOZ_LITE
ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS, (SEC_DIALOG_STRING_BASE + 275), "\
%sec-banner-begin%%0%%sec-banner-end%\
By accepting this \
Certificate Authority, you have told Netscape Navigator \
%-cont-%")
#else
ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS, (SEC_DIALOG_STRING_BASE + 275), "\
%sec-banner-begin%%0%%sec-banner-end%\
...
#ifdef MOZ_LITE
ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS_1, (SEC_DIALOG_STRING_BASE + 276), "\
to connect to and receive information from any site that it certifies  \
without warning you or prompting you.<p>Netscape Navigator can, however, \
warn you before \
%-cont-%")
#else
ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS_1, (SEC_DIALOG_STRING_BASE + 276), "\
to connect to and receive information from any site that it certifies  \
without warning you or prompting you.<p>Netscape Communicator can, however, \
warn you before \
%-cont-%")
#endif

ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS_2, (SEC_DIALOG_STRING_BASE + 277), "\
...
ResDef(XP_CA_CERT_DOWNLOAD5_STRINGS_3, (SEC_DIALOG_STRING_BASE + 278), "\
certified by this Certificate Authority")

ResDef(XP_CA_CERT_DOWNLOAD6_STRINGS, (SEC_DIALOG_STRING_BASE + 279), "\
%sec-banner-begin%%0%%sec-banner-end%\
You have accepted \
this Certificate Authority.  You must now select a nickname that will be \
%-cont-%")

ResDef(XP_CA_CERT_DOWNLOAD6_STRINGS_1, (SEC_DIALOG_STRING_BASE + 280), "\
...
ResDef(XP_CA_CERT_DOWNLOAD6_STRINGS_2, (SEC_DIALOG_STRING_BASE + 281), "\
name=nickname></font>")

#ifdef MOZ_LITE
ResDef(XP_CA_CERT_DOWNLOAD7_STRINGS, (SEC_DIALOG_STRING_BASE + 282), "\
%sec-banner-begin%%0%%sec-banner-end%\
By rejecting this \
Certificate Authority, you have told Netscape Navigator not to connect \
%-cont-%")
#else
ResDef(XP_CA_CERT_DOWNLOAD7_STRINGS, (SEC_DIALOG_STRING_BASE + 282), "\
%sec-banner-begin%%0%%sec-banner-end%\
...
ResDef(XP_CA_CERT_DOWNLOAD7_STRINGS_1, (SEC_DIALOG_STRING_BASE + 283), "\
to and receive information from any site that it certifies without \
prompting you.")

ResDef(XP_EMPTY_STRINGS, (SEC_DIALOG_STRING_BASE + 294), "\
%0%")

ResDef(XP_WHICH_CERT_CLIENT_AUTH_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 295), "\
%sec-banner-begin%%0%%sec-banner-end%\
The site '%1%' \
has requested client authentication.<p>Here is the \
%-cont-%")

ResDef(XP_WHICH_CERT_CLIENT_AUTH_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 296), "\
...
ResDef(XP_WHICH_CERT_CLIENT_AUTH_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 297), "\
...
ResDef(XP_WHICH_CERT_CLIENT_AUTH_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 298), "\
\042></td></tr></table><hr>Select Your Certificate:<select name=cert>\
%7%</select>%8%")

ResDef(XP_NO_CERT_CLIENT_AUTH_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 304), "\
%sec-banner-begin%%0%%sec-banner-end%\
The site '%1%' \
has requested client authentication, but you do not have a Personal \
%-cont-%")

ResDef(XP_NO_CERT_CLIENT_AUTH_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 305), "\
Certificate to authenticate yourself.  The site may choose not to give \
you access without one.%2%")

ResDef(XP_BROWSER_SEC_INFO_ENCRYPTED_STRINGS, (SEC_DIALOG_STRING_BASE + 306), "\
%sec-banner-begin%%0%%sec-banner-end%\
<B>All of the \
files that you have requested were encrypted.</B><p> This means that the \
%-cont-%")

ResDef(XP_BROWSER_SEC_INFO_ENCRYPTED_STRINGS_1, (SEC_DIALOG_STRING_BASE + 307), "\
...
ResDef(XP_BROWSER_SEC_INFO_ENCRYPTED_STRINGS_2, (SEC_DIALOG_STRING_BASE + 308), "\
...
ResDef(XP_BROWSER_SEC_INFO_ENCRYPTED_STRINGS_3, (SEC_DIALOG_STRING_BASE + 309), "\
value=\042%showdocinfo%\042></center>%1%")

ResDef(XP_BROWSER_SEC_INFO_MIXED_STRINGS, (SEC_DIALOG_STRING_BASE + 315), "\
...
ResDef(XP_BROWSER_SEC_INFO_MIXED_STRINGS_1, (SEC_DIALOG_STRING_BASE + 316), "\
...
ResDef(XP_BROWSER_SEC_INFO_MIXED_STRINGS_2, (SEC_DIALOG_STRING_BASE + 317), "\
...
ResDef(XP_BROWSER_SEC_INFO_MIXED_STRINGS_3, (SEC_DIALOG_STRING_BASE + 318), "\
value=\042%ok%\042><input type=\042submit\042 name=\042button\042 value=\042\
%showdocinfo%\042></center>%1%")

ResDef(XP_BROWSER_SEC_INFO_CLEAR_STRINGS, (SEC_DIALOG_STRING_BASE + 319), "\
...
ResDef(XP_BROWSER_SEC_INFO_CLEAR_STRINGS_1, (SEC_DIALOG_STRING_BASE + 320), "\
...
ResDef(	XP_SMIME_RC2_CBC_40,		(SEC_DIALOG_STRING_BASE + 336), \
"RC2 encryption in CBC mode with a 40-bit key")

ResDef(	XP_SMIME_RC2_CBC_64,		(SEC_DIALOG_STRING_BASE + 337), \
"RC2 encryption in CBC mode with a 64-bit key")

ResDef(	XP_SMIME_RC2_CBC_128,		(SEC_DIALOG_STRING_BASE + 338), \
"RC2 encryption in CBC mode with a 128-bit key")

ResDef(	XP_SMIME_DES_CBC,		(SEC_DIALOG_STRING_BASE + 339), \
"DES encryption in CBC mode with a 56-bit key")

ResDef(	XP_SMIME_DES_EDE3,		(SEC_DIALOG_STRING_BASE + 340), \
"DES EDE3 encryption in CBC mode with a 168-bit key")

ResDef(	XP_SMIME_RC5PAD_64_16_40,	(SEC_DIALOG_STRING_BASE + 341), \
"RC5 encryption in CBC mode with a 40-bit key")

ResDef(	XP_SMIME_RC5PAD_64_16_64,	(SEC_DIALOG_STRING_BASE + 342), \
"RC5 encryption in CBC mode with a 64-bit key")

ResDef(	XP_SMIME_RC5PAD_64_16_128,	(SEC_DIALOG_STRING_BASE + 343), \
"RC5 encryption in CBC mode with a 128-bit key")

/* (There used to be strings for payment stuff here.) */

#ifdef MOZ_LITE
ResDef(XP_CONFIG_NO_POLICY_STRINGS, (SEC_DIALOG_STRING_BASE + 351), \
"No valid encryption policy file was found for this English language \n\
version of Navigator.  All encryption and decryption will be disabled.")
#else
ResDef(XP_CONFIG_NO_POLICY_STRINGS, (SEC_DIALOG_STRING_BASE + 351), \
"No valid encryption policy file was found for this English language \n\
...
ResDef(XP_CONFIG_NO_CIPHERS_STRINGS, (SEC_DIALOG_STRING_BASE + 352), \
"  (No ciphers are permitted)")

ResDef(XP_CONFIG_MAYBE_CIPHERS_STRINGS, (SEC_DIALOG_STRING_BASE + 353), \
"  (When permitted)")

ResDef(XP_CONFIG_SMIME_CIPHERS_STRINGS, (SEC_DIALOG_STRING_BASE + 354), "\
%sec-banner-begin%%0%%sec-banner-end%\
<h3>Select ciphers to enable for S/MIME %1%</h3><ul>%2%</ul>%3%")

ResDef(XP_CONFIG_SSL2_CIPHERS_STRINGS, (SEC_DIALOG_STRING_BASE + 355), "\
%sec-banner-begin%%0%%sec-banner-end%\
<h3>Select ciphers to enable for SSL v2 %1%</h3><ul>%2%</ul>%3%")

ResDef(XP_CONFIG_SSL3_CIPHERS_STRINGS, (SEC_DIALOG_STRING_BASE + 356), "\
%sec-banner-begin%%0%%sec-banner-end%\
<h3>Select ciphers to enable for SSL v3 %1%</h3><ul>%2%</ul>%3%")

#ifdef MOZ_LITE
ResDef(XP_USER_CERT_DOWNLOAD_STRINGS, (SEC_DIALOG_STRING_BASE + 362), "\
%sec-banner-begin%%0%%sec-banner-end%\
...
#ifdef MOZ_LITE
ResDef(XP_USER_CERT_DOWNLOAD_STRINGS_1, (SEC_DIALOG_STRING_BASE + 363), "\
Certificate by the name shown below.  %1%<P>Click <B>OK</B> to install the \
certificate into Navigator or click <B>Cancel</B> to refuse your new \
%-cont-%")
#else
ResDef(XP_USER_CERT_DOWNLOAD_STRINGS_1, (SEC_DIALOG_STRING_BASE + 363), "\
Certificate by the name shown below.  %1%<P>Click <B>OK</B> to install the \
...
ResDef(XP_USER_CERT_DOWNLOAD_STRINGS_2, (SEC_DIALOG_STRING_BASE + 364), "\
...
ResDef(XP_USER_CERT_DOWNLOAD_STRINGS_3, (SEC_DIALOG_STRING_BASE + 365), "\
value=\042%showcert%\042></td></tr></table><HR><P>%5%</font>")

ResDef(XP_USER_CERT_NICKNAME_STRINGS,	(SEC_DIALOG_STRING_BASE + 371), "\
You can use the name provided or enter a new one.")

ResDef(XP_USER_CERT_DL_MOREINFO_STRINGS, (SEC_DIALOG_STRING_BASE + 372), "\
%sec-banner-begin%%0%%sec-banner-end%\
A Certificate is arriving from %1%.<p>This Certificate works in conjunction \
%-cont-%")

ResDef(XP_USER_CERT_DL_MOREINFO_STRINGS_1, (SEC_DIALOG_STRING_BASE + 373), "\
...
#ifdef MOZ_LITE
ResDef(XP_USER_CERT_DL_MOREINFO_STRINGS_2, (SEC_DIALOG_STRING_BASE + 374), "\
traditional username and password security methods.  For more information \
about Certificates, choose <b>Security Info</b> from the Navigator menu.")
#else
ResDef(XP_USER_CERT_DL_MOREINFO_STRINGS_2, (SEC_DIALOG_STRING_BASE + 374), "\
traditional username and password security methods.  For more information \
...
ResDef(XP_USER_CERT_SAVE_STRINGS,	(SEC_DIALOG_STRING_BASE + 380), "\
%sec-banner-begin%%0%%sec-banner-end%\
You should make a copy of your new Certificate.<p>If you lose your Certificate \
%-cont-%")

ResDef(XP_USER_CERT_SAVE_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 381), "\
...
ResDef(XP_USER_CERT_SAVE_STRINGS_2,	(SEC_DIALOG_STRING_BASE + 382), "\
...
ResDef(XP_USER_CERT_SAVE_STRINGS_3,	(SEC_DIALOG_STRING_BASE + 383), "\
floppy disk that you keep in a safe location.<p><input type=submit \
name=button value=\042%saveas%\042>")

ResDef(XP_USER_CERT_SAVE_TITLE,		(SEC_DIALOG_STRING_BASE + 384), "\
Save User Certificate")



#ifdef MOZ_LITE
ResDef(XP_KEY_GEN_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 392), "\
%sec-banner-begin%%0%%sec-banner-end%\
When you click OK, Navigator will generate a Private Key for your \
%-cont-%")
#else
ResDef(XP_KEY_GEN_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 392), "\
%sec-banner-begin%%0%%sec-banner-end%\
...
ResDef(XP_KEY_GEN_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 393), "\
...
ResDef(XP_KEY_GEN_MOREINFO_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 394), "\
Key Generation Info")
ResDef(XP_CERT_DL_MOREINFO_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 400), "\
Certificate Download Info")


ResDef(XP_CERT_EXPIRED_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 401), "\
%sec-banner-begin%%0%%sec-banner-end%\
%1% is a site \
that uses encryption to protect transmitted information.  However the \
%-cont-%")

ResDef(XP_CERT_EXPIRED_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 402), "\
...
ResDef(XP_CERT_EXPIRED_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 403), "\
...
ResDef(XP_CERT_EXPIRED_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 404), "\
should reset the date on your computer.<p>You may continue or cancel \
this connection.%4%")

ResDef(XP_CERT_NOT_YET_GOOD_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 410), "\
%sec-banner-begin%%0%%sec-banner-end%\
%1% is a site \
that uses encryption to protect transmitted information.  However the \
%-cont-%")

ResDef(XP_CERT_NOT_YET_GOOD_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 411), "\
...
ResDef(XP_CERT_NOT_YET_GOOD_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 412), "\
...
ResDef(XP_CERT_NOT_YET_GOOD_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 413), "\
...
ResDef(XP_CA_EXPIRED_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 419), "\
%sec-banner-begin%%0%%sec-banner-end%\
%1% is a site \
that uses encryption to protect transmitted information.  However one of \
%-cont-%")

ResDef(XP_CA_EXPIRED_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 420), "\
...
ResDef(XP_CA_EXPIRED_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 421), "\
...
ResDef(XP_CA_EXPIRED_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 422), "\
valign=top><font size=2>Certificate Authority: <br>Expiration Date: \
</font></td><td valign=top><font size=2>%2%<br>%3%</font></td><td \
%-cont-%")

ResDef(XP_CA_EXPIRED_DIALOG_STRINGS_4, (SEC_DIALOG_STRING_BASE + 423), "\
...
ResDef(XP_CA_EXPIRED_DIALOG_STRINGS_5, (SEC_DIALOG_STRING_BASE + 424), "\
...
ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 430), "\
%sec-banner-begin%%0%%sec-banner-end%\
%1% is a site \
that uses encryption to protect transmitted information.  However one of \
%-cont-%")

ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 431), "\
...
ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 432), "\
...
ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 433), "\
...
ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_4, (SEC_DIALOG_STRING_BASE + 434), "\
size=2>%2%<br>%3%</font></td><td valign=center align=right><input \
type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042></td></tr></table>\
%-cont-%")

ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_5, (SEC_DIALOG_STRING_BASE + 435), "\
...
ResDef(XP_CA_NOT_YET_GOOD_DIALOG_STRINGS_6, (SEC_DIALOG_STRING_BASE + 436), "\
this connection.")
ResDef(XP_SEC_CANCEL, (SEC_DIALOG_STRING_BASE + 492), "\
Cancel")

ResDef(XP_SEC_OK, (SEC_DIALOG_STRING_BASE + 493), "\
OK")

ResDef(XP_SEC_CONTINUE, (SEC_DIALOG_STRING_BASE + 494), "\
Continue")

/* These must match the kludge versions below */

ResDef(XP_SEC_NEXT, (SEC_DIALOG_STRING_BASE + 495), "\
Next&gt;")

ResDef(XP_SEC_BACK, (SEC_DIALOG_STRING_BASE + 496), "\
&lt;Back")

ResDef(XP_SEC_FINISHED, (SEC_DIALOG_STRING_BASE + 497), "\
Finish")

ResDef(XP_SEC_MOREINFO, (SEC_DIALOG_STRING_BASE + 498), "\
More Info...")

ResDef(XP_SEC_SHOWCERT, (SEC_DIALOG_STRING_BASE + 499), "\
Show Certificate")

ResDef(XP_SEC_SHOWORDER, (SEC_DIALOG_STRING_BASE + 500), "\
Show Order")

ResDef(XP_SEC_SHOWDOCINFO, (SEC_DIALOG_STRING_BASE + 501), "\
Show Document Info")

/* These must match the original versions above */

ResDef(XP_SEC_NEXT_KLUDGE, (SEC_DIALOG_STRING_BASE + 507), "\
Next>")

ResDef(XP_SEC_BACK_KLUDGE, (SEC_DIALOG_STRING_BASE + 508), "\
<Back")

ResDef(XP_SEC_SAVEAS,			(SEC_DIALOG_STRING_BASE + 509), "\
Save As...")


ResDef(XP_ALERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 516), "\
Alert")

ResDef(XP_VIEWCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 517), "\
View A Certificate")

ResDef(XP_CERTDOMAIN_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 518), "\
Certificate Name Check")

ResDef(XP_CERTISEXP_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 519), "\
Certificate Is Expired")

ResDef(XP_CERTNOTYETGOOD_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 520), "\
Certificate Is Not Yet Good")

ResDef(XP_CAEXP_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 521), "\
Certificate Authority Is Expired")

ResDef(XP_CANOTYETGOOD_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 522), "\
Certificate Authority Is Not Yet Good")

ResDef(XP_ENCINFO_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 523), "\
Encryption Information")
ResDef(XP_VIEWPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 534), "\
View A Personal Certificate")

ResDef(XP_DELPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 535), "\
Delete A Personal Certificate")

ResDef(XP_DELSCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 536), "\
Delete A Site Certificate")

ResDef(XP_DELCACERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 537), "\
Delete A Certificate Authority")

ResDef(XP_EDITSCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 538), "\
Edit A Site Certificate")

ResDef(XP_EDITCACERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 539), "\
Edit A Certification Authority")

ResDef(XP_NOPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 540), "\
No User Certificate")

ResDef(XP_SELPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 541), "\
Select A Certificate")

ResDef(XP_SECINFO_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 542), "\
Security Information")

ResDef(XP_GENKEY_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 543), "\
Generate A Private Key")

ResDef(XP_NEWSCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 544), "\
New Site Certificate")

ResDef(XP_NEWCACERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 545), "\
New Certificate Authority")

ResDef(XP_NEWPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 546), "\
New User Certificate")

#ifdef MOZ_LITE
ResDef(XP_SETUPNSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 552), "\
Setting Up Your Navigator Password")
#else
ResDef(XP_SETUPNSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 552), "\
...
#ifdef MOZ_LITE
ResDef(XP_CHANGENSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 553), "\
Change Your Navigator Password")
#else
ResDef(XP_CHANGENSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 553), "\
...
#ifdef MOZ_LITE
ResDef(XP_ENABLENSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 554), "\
Enable Your Navigator Password")
#else
ResDef(XP_ENABLENSPW_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 554), "\
Enable Your Communicator Password")
#endif

ResDef(XP_PWERROR_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 555), "\
Password Error")

ResDef(XP_CONFCIPHERS_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 556), "\
Configure Ciphers")

ResDef(XP_CLIENT_CERT_EXPIRED_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 557), "\
%sec-banner-begin%%0%%sec-banner-end%\
The certificate that you have selected has expired and may \
%-cont-%")

ResDef(XP_CLIENT_CERT_EXPIRED_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 558), "\
be rejected by the server.  You may press Continue to send it \
anyway, or Cancel to abort this connection.")

ResDef(XP_CLIENT_CERT_EXPIRED_RENEWAL_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 569), "\
%sec-banner-begin%%0%%sec-banner-end%\
<table><tr><td>The certificate that you have selected has expired and may \
%-cont-%")

ResDef(XP_CLIENT_CERT_EXPIRED_RENEWAL_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 570), "\
be rejected by the server.  You may press %continue% to send it \
anyway, or %cancel% to abort this connection.  To renew your \
%-cont-%")

ResDef(XP_CLIENT_CERT_EXPIRED_RENEWAL_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 571), "\
certificate press the %renew% button.</td><td><input type=submit \
name=button value=%renew%></td></tr></table>")

ResDef(XP_SEC_RENEW, (SEC_DIALOG_STRING_BASE + 577), "\
Renew")

ResDef(XP_CLIENT_CERT_NOT_YET_GOOD_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 578), "\
%sec-banner-begin%%0%%sec-banner-end%\
The certificate that you have selected is not yet valid and may \
be rejected by the server.  You may press Continue to send it \
anyway, or Cancel to abort this connection.")

ResDef(XP_CLCERTEXP_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 579), "\
Your Certificate Is Expired")

ResDef(XP_ASKUSER, (SEC_DIALOG_STRING_BASE + 580), "\
Ask every time")

#ifdef MOZ_LITE
ResDef(XP_PICKAUTO, (SEC_DIALOG_STRING_BASE + 581), "\
Let Navigator choose automatically")
#else
ResDef(XP_PICKAUTO, (SEC_DIALOG_STRING_BASE + 581), "\
Let Communicator choose automatically")
#endif

ResDef(XP_HIGH_GRADE, (SEC_DIALOG_STRING_BASE + 582), "\
1024 (High Grade)")

ResDef(XP_MEDIUM_GRADE, (SEC_DIALOG_STRING_BASE + 583), "\
 768 (Medium Grade)")

ResDef(XP_LOW_GRADE, (SEC_DIALOG_STRING_BASE + 584), "\
 512 (Low Grade)")
ResDef(XP_VIEW_CERT_POLICY, (SEC_DIALOG_STRING_BASE + 640), "\
View Certificate Policy")

ResDef(XP_CHECK_CERT_STATUS, (SEC_DIALOG_STRING_BASE + 641), "\
Check Certificate Status")

ResDef(XP_SSL2_RC4_128, (SEC_DIALOG_STRING_BASE + 642), "\
RC4 encryption with a 128-bit key")

ResDef(XP_SSL2_RC2_128, (SEC_DIALOG_STRING_BASE + 643), "\
RC2 encryption with a 128-bit key")

ResDef(XP_SSL2_DES_192_EDE3, (SEC_DIALOG_STRING_BASE + 644), "\
Triple DES encryption with a 168-bit key")

ResDef(XP_SSL2_DES_64, (SEC_DIALOG_STRING_BASE + 645), "\
DES encryption with a 56-bit key")

ResDef(XP_SSL2_RC4_40, (SEC_DIALOG_STRING_BASE + 646), "\
RC4 encryption with a 40-bit key")

ResDef(XP_SSL2_RC2_40, (SEC_DIALOG_STRING_BASE + 647), "\
RC2 encryption with a 40-bit key")

ResDef(XP_SSL3_RSA_RC4_128_MD5, (SEC_DIALOG_STRING_BASE + 653), "\
RC4 encryption with a 128-bit key and an MD5 MAC")

ResDef(XP_SSL3_RSA_3DES_SHA, (SEC_DIALOG_STRING_BASE + 654), "\
Triple DES encryption with a 168-bit key and a SHA-1 MAC")

ResDef(XP_SSL3_RSA_DES_SHA, (SEC_DIALOG_STRING_BASE + 655), "\
DES encryption with a 56-bit key and a SHA-1 MAC")

ResDef(XP_SSL3_RSA_RC4_40_MD5, (SEC_DIALOG_STRING_BASE + 656), "\
RC4 encryption with a 40-bit key and an MD5 MAC")

ResDef(XP_SSL3_RSA_RC2_40_MD5, (SEC_DIALOG_STRING_BASE + 657), "\
RC2 encryption with a 40-bit key and an MD5 MAC")

ResDef(XP_SSL3_RSA_NULL_MD5, (SEC_DIALOG_STRING_BASE + 658), "\
No encryption with an MD5 MAC")

ResDef(XP_DIALOG_SHOW_CRLS, (SEC_DIALOG_STRING_BASE + 709), "\
<h3>CRL List:</h3>\
<table><tr><td><select name=crl size=10>%0%</select>\
</td><td valign=\042middle\042>%-cont-%")

ResDef(XP_DIALOG_SHOW_CRLS_1, (SEC_DIALOG_STRING_BASE + 710), "\
<input type=\042submit\042 name=\042button\042 value=\042%new%\042>\
</input><br>%-cont-%")

ResDef(XP_DIALOG_SHOW_CRLS_2, (SEC_DIALOG_STRING_BASE + 711), "\
<input type=\042submit\042 name=\042button\042 value=\042%reload%\042>\
</input><br>%-cont-%")

ResDef(XP_DIALOG_SHOW_CRLS_3, (SEC_DIALOG_STRING_BASE + 712), "\
<input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042>\
</input><br>%-cont-%")

ResDef(XP_DIALOG_SHOW_CRLS_4, (SEC_DIALOG_STRING_BASE + 713), "\
<input type=\042submit\042 name=\042button\042 value=\042%delete%\042>\
</input><br>%-cont-%")

ResDef(XP_DIALOG_SHOW_CRLS_5, (SEC_DIALOG_STRING_BASE + 714), "\
</td></tr></table>")

ResDef(XP_SEC_NEW, (SEC_DIALOG_STRING_BASE + 715), "New/Edit ...")

ResDef(XP_SEC_RELOAD, (SEC_DIALOG_STRING_BASE + 716), "\
Reload")

ResDef(XP_SEC_DELETE, (SEC_DIALOG_STRING_BASE + 717), "\
Delete")

ResDef(XP_DIALOG_EDIT_MODULE_TITLE, (SEC_DIALOG_STRING_BASE + 727), "\
Edit Security Module")

ResDef(XP_DIALOG_NEW_MODULE_TITLE, (SEC_DIALOG_STRING_BASE + 728), "\
Create a New Security Module")

/* Ciphers */
ResDef(XP_SSL3_FORTEZZA_SHA, (SEC_DIALOG_STRING_BASE + 734), "\
FORTEZZA encryption with a 80-bit key and an SHA-1 MAC")

ResDef(XP_SSL3_FORTEZZA_RC4_SHA, (SEC_DIALOG_STRING_BASE + 735), "\
FORTEZZA authentication with RC4 128-bit key and an SHA-1 MAC")

ResDef(XP_SSL3_FORTEZZA_NULL_SHA, (SEC_DIALOG_STRING_BASE + 736), "\
No encryption with FORTEZZA authentication and an SHA-1 MAC")


ResDef(XP_SEC_ENTER_PWD, (SEC_DIALOG_STRING_BASE + 742), "\
Please enter the password or the pin for\n\
%s.")

ResDef(XP_SSO_GET_PW_STRINGS, (SEC_DIALOG_STRING_BASE + 743), "\
%sec-banner-begin%%0%%sec-banner-end%\
The %1% has not been initialized with a User PIN or Password.  In order \
%-cont-%")

ResDef(XP_SSO_GET_PW_STRINGS_1, (SEC_DIALOG_STRING_BASE + 744), "\
...
ResDef(XP_SSO_GET_PW_STRINGS_2, (SEC_DIALOG_STRING_BASE + 745), "\
...
ResDef(XP_PW_RETRY_SSO_STRINGS, (SEC_DIALOG_STRING_BASE + 751), "\
%sec-banner-begin%%0%%sec-banner-end%\
The administration password you entered for the %1% was incorrect.  \
%-cont-%")

ResDef(XP_PW_RETRY_SSO_STRINGS_1, (SEC_DIALOG_STRING_BASE + 752), "\
...
ResDef(XP_PW_RETRY_SSO_STRINGS_2, (SEC_DIALOG_STRING_BASE + 753), "\
back to your issuer to be initialized.<p>Enter adminstration Password for \
the %2%:<input type=password name=ssopassword>.")

ResDef(XP_PW_SETUP_SSO_FAIL_STRINGS, (SEC_DIALOG_STRING_BASE + 754), "\
%sec-banner-begin%%0%%sec-banner-end%\
The %1% could not be initialized because of the following error:<p> \
%2%")

ResDef(XP_SEC_EDIT, (SEC_DIALOG_STRING_BASE + 755), "\
Edit Defaults...")

ResDef(XP_SEC_LOGIN, (SEC_DIALOG_STRING_BASE + 756), "\
Login")

ResDef(XP_SEC_LOGOUT, (SEC_DIALOG_STRING_BASE + 757), "\
Logout")

ResDef(XP_SECURITY_ADVISOR, (SEC_DIALOG_STRING_BASE + 758), "\
%0%%1%%2%%3%%4%%5%")

ResDef(XP_SECURITY_ADVISOR_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 759), "\
Security Info")

ResDef(XP_SEC_SETPASSWORD, (SEC_DIALOG_STRING_BASE + 760), "\
Set Password...")

ResDef(XP_SEC_NO_LOGIN_NEEDED, (SEC_DIALOG_STRING_BASE + 761), "\
Slot or Token does not require a login.")

ResDef(XP_SEC_ALREADY_LOGGED_IN, (SEC_DIALOG_STRING_BASE + 762), "\
Slot or Token is already logged in.")

ResDef(XP_KEY_GEN_TOKEN_SELECT, (SEC_DIALOG_STRING_BASE + 763), "\
<p>Select the card or database you wish to generate your key in:\
<SELECT name=\042tokenName\042>")

ResDef(XP_SEC_SLOT_READONLY, (SEC_DIALOG_STRING_BASE + 764), "\
Token %s is write protected, certs and keys cannot be deleted")

ResDef(PK11_COULD_NOT_INIT_TOKEN, (SEC_DIALOG_STRING_BASE + 766), "\
Slot failed to Initialize.")

ResDef(PK11_USER_SELECTED, (SEC_DIALOG_STRING_BASE + 767), "\
User has manually disabled this slot.")

ResDef(PK11_TOKEN_VERIFY_FAILED, (SEC_DIALOG_STRING_BASE + 768), "\
Token failed startup tests.")

ResDef(PK11_TOKEN_NOT_PRESENT, (SEC_DIALOG_STRING_BASE + 769), "\
Permanent Token not present.")

ResDef(XP_JAVA_SECURITY_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 780), "\
Java Security")

ResDef(XP_DELETE_JAVA_PRIV_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 781), "\
Java Security (Delete Privilege)")

ResDef(XP_EDIT_JAVA_PRIV_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 782), "\
Java Security (Edit Privileges)")

ResDef(XP_DELETE_JAVA_PRIN_STRINGS, (SEC_DIALOG_STRING_BASE + 783), "\
Are you sure that you want to delete all the privileges for all applets \
and scripts from <b>%0%</b>?")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS, (SEC_DIALOG_STRING_BASE + 784), "\
Allow applets and scripts from <b> %0% </b> to have the following access \
%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_1, (SEC_DIALOG_STRING_BASE + 785), "\
<table><tr><td colspan=3>Always:</td></tr> \
<tr><td><select name=target size=3> %1% </select></td> \
%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_2, (SEC_DIALOG_STRING_BASE + 786), "\
<td></td><td> <input type=\042submit\042 name=\042button\042 \
value=\042%delete%\042></input>%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_3, (SEC_DIALOG_STRING_BASE + 787), "\
<input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042>\
</input></td></tr></table>%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_4, (SEC_DIALOG_STRING_BASE + 788), "\
<table><tr><td colspan=3>For this session only:</td></tr> \
<tr><td><select name=target size=3> %2% </select></td> \
%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_5, (SEC_DIALOG_STRING_BASE + 789), "\
<td></td><td> <input type=\042submit\042 name=\042button\042 \
value=\042%delete%\042></input>%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_6, (SEC_DIALOG_STRING_BASE + 790), "\
<input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042>\
</input></td></tr></table>%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_7, (SEC_DIALOG_STRING_BASE + 791), "\
<table><tr><td colspan=3>Never:</td></tr> \
<tr><td><select name=target size=3> %3% </select></td> \
%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_8, (SEC_DIALOG_STRING_BASE + 792), "\
<td></td><td> <input type=\042submit\042 name=\042button\042 \
value=\042%delete%\042></input>%-cont-%")

ResDef(XP_EDIT_JAVA_PRIVILEGES_STRINGS_9, (SEC_DIALOG_STRING_BASE + 793), "\
<input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042>\
</input></td></tr></table>")

ResDef(XP_DELETE_JAVA_PRIV_STRINGS, (SEC_DIALOG_STRING_BASE + 804), "\
Are you sure that you want to delete the <b>%0%</b> privileges for \
all applets and scripts from <b>%1%</b>?")

ResDef(XP_MOREINFO_JAVA_PRIV_STRINGS, (SEC_DIALOG_STRING_BASE + 805), "\
 ...
 */
ResDef(XP_SIGNED_CERT_PRIV_STRINGS, (SEC_DIALOG_STRING_BASE + 806), "\
<table BORDER=0><tr><td VALIGN=top><font SIZE=2><b>Danger \
<SPACER TYPE=horizontal SIZE=7></B><br></td> \
%-cont-%")

ResDef(XP_SIGNED_CERT_PRIV_STRINGS_1, (SEC_DIALOG_STRING_BASE + 807), "\
...
ResDef(XP_SIGNED_CERT_PRIV_STRINGS_2, (SEC_DIALOG_STRING_BASE + 808), "\
...
ResDef(XP_SIGNED_CERT_PRIV_STRINGS_3, (SEC_DIALOG_STRING_BASE + 809), "\
</center><spacer type=vertical size=20></td></tr> \
<tr><td></td><td><font size=2>The access requested is <b>%1%</b> \
and consists of:</td></tr> \
%-cont-%")

ResDef(XP_SIGNED_CERT_PRIV_STRINGS_4, (SEC_DIALOG_STRING_BASE + 810), "\
...
ResDef(XP_SIGNED_CERT_PRIV_STRINGS_5, (SEC_DIALOG_STRING_BASE + 811), "\
...
ResDef(XP_SIGNED_CERT_PRIV_STRINGS_6, (SEC_DIALOG_STRING_BASE + 812), "\
...
ResDef(XP_SIGNED_CERT_PRIV_STRINGS_7, (SEC_DIALOG_STRING_BASE + 813), "\
 ...
 */
ResDef(XP_SIGNED_APPLET_PRIV_STRINGS, (SEC_DIALOG_STRING_BASE + 824), "\
<table BORDER=0><tr><td VALIGN=top><font SIZE=2><b>Danger \
<SPACER TYPE=horizontal SIZE=7></B><br></td> \
%-cont-%")

ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_1, (SEC_DIALOG_STRING_BASE + 825), "\
...
ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_2, (SEC_DIALOG_STRING_BASE + 826), "\
...
ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_3, (SEC_DIALOG_STRING_BASE + 827), "\
<tr><td coldspan=2><center><table> \
<td><select multiple name=target size=4>%2%</select></td> \
<td><input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042> \
</input></td></table></center></td></tr></table> \
...
ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_4, (SEC_DIALOG_STRING_BASE + 828), "\
<br>Do you wish to grant the requested access? \
<br><spacer type=horizontal size=5><input type=radio name=perm value=yes> \
...
ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_5, (SEC_DIALOG_STRING_BASE + 829), "\
<br><spacer type=horizontal size=5><input type=radio name=perm \
value=no checked> No, deny this access (This may mean the applet \
or script cannot work properly) \
%-cont-%")

ResDef(XP_SIGNED_APPLET_PRIV_STRINGS_6, (SEC_DIALOG_STRING_BASE + 830), "\
<br><input type=checkbox name=remember> \
Remember this decision for all applets and scripts on the \042<b>%0%</b>\042 \
server <br></td></table>")

ResDef(XP_DIALOG_NEW_MODULE, (SEC_DIALOG_STRING_BASE + 841), "\
<b>Security Module Name:</b> <input name=\042name\042><br>\
<b>Security Module File:</b> <input name=\042library\042><br>")

ResDef(XP_SEC_MODULE_NO_LIB, (SEC_DIALOG_STRING_BASE + 842), "\
You must specify a PKCS #11 Version 2.0 library to load\n")

ResDef(XP_DIALOG_SLOT_INFO, (SEC_DIALOG_STRING_BASE + 843), "\
<b>Slot Description:</b> %0%<br><b>Manufacturer:</b> %1%<br>\
<b>Version Number:</b> %2%<br><b>Firmware Version:</b> %3%<br>\
%-cont-%")

ResDef(XP_DIALOG_SLOT_INFO_1, (SEC_DIALOG_STRING_BASE + 844), "\
%4%<b>Token Name:</b> %5%<br><b>Token Manufacturer:</b>%6%<br>\
<b>Token Model:</b> %7%<br><b>Token Serial Number:</b>%8%<br>\
%-cont-%")

ResDef(XP_DIALOG_SLOT_INFO_2, (SEC_DIALOG_STRING_BASE + 845), "\
<b>Token Version:</b> %9%<br><b>Token Firmware Version:</b> %10%<br>\
<b>Login Type:</b> %11%<br><b>State:</b>%12%%13%%14%")

ResDef(XP_DIALOG_SLOT_INFO_TITLE, (SEC_DIALOG_STRING_BASE + 846), "\
Token/Slot Information")

ResDef(XP_SLOT_LOGIN_REQUIRED, (SEC_DIALOG_STRING_BASE + 847), "\
Login Required")

ResDef(XP_SLOT_NO_LOGIN_REQUIRED, (SEC_DIALOG_STRING_BASE + 848), "\
Public (no login required)")

ResDef(XP_SLOT_READY, (SEC_DIALOG_STRING_BASE + 849), "\
Ready")

ResDef(XP_SLOT_NOT_LOGGED_IN, (SEC_DIALOG_STRING_BASE + 850), "\
<font color=red>Not Logged In</font>")

ResDef(XP_SLOT_UNITIALIZED, (SEC_DIALOG_STRING_BASE + 851), "\
<font color=red>Uninitialized</font>")

ResDef(XP_SLOT_NOT_PRESENT, (SEC_DIALOG_STRING_BASE + 852), "\
<font color=red>Not Present</font>")

ResDef(XP_SLOT_DISABLED, (SEC_DIALOG_STRING_BASE + 853), "\
<font color=red>Disabled(")

ResDef(XP_SLOT_DISABLED_2, (SEC_DIALOG_STRING_BASE + 854), "\
)</font>")

ResDef(XP_SLOT_PASSWORD_INIT, (SEC_DIALOG_STRING_BASE + 860), "\
 Initialize Token")

ResDef(XP_SLOT_PASSWORD_CHANGE, (SEC_DIALOG_STRING_BASE + 861), "\
 Change Password ")

ResDef(XP_SLOT_PASSWORD_SET, (SEC_DIALOG_STRING_BASE + 862), "\
   Set Password  ")

ResDef(XP_SLOT_PASSWORD_NO, (SEC_DIALOG_STRING_BASE + 863), "\
   No Password   ")

ResDef(XP_DOWNLOAD_EMAIL_CERT_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 864), "\
%sec-banner-begin%%0%%sec-banner-end%\
You are downloading the e-mail certificate of another user.  After accepting \
%-cont-%")

ResDef(XP_DOWNLOAD_EMAIL_CERT_DIALOG_STRINGS_1, (SEC_DIALOG_STRING_BASE + 865), "\
...
ResDef(XP_DOWNLOAD_EMAIL_CERT_DIALOG_STRINGS_2, (SEC_DIALOG_STRING_BASE + 866), "\
<hr><table cellspacing=0 cellpadding=0><tr><td valign=top>\
<table cellspacing=0 cellpadding=0><tr><td><font size=2>Certificate For:\
%-cont-%")

ResDef(XP_DOWNLOAD_EMAIL_CERT_DIALOG_STRINGS_3, (SEC_DIALOG_STRING_BASE + 867), "\
</font></td><td><font size=2>%1%</font></td></tr><tr><td><font size=2>\
Email Address:</font></td><td><font size=2>%2%</font></td></tr><tr><td>\
%-cont-%")

ResDef(XP_DOWNLOAD_EMAIL_CERT_DIALOG_STRINGS_4, (SEC_DIALOG_STRING_BASE + 868), "\
<font size=2>Certified By:</font></td><td><font size=2>%3%</font></td></tr>\
</table></td><td valign=center align=right>\
<input type=\042submit\042 name=\042button\042 value=\042%moreinfo%\042>\
</td></tr></table><hr>")

ResDef(XP_EMAIL_CERT_DOWNLOAD_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 874), "\
Download an E-Mail Certificate")

ResDef(XP_CA_CERT_SSL_OK_STRING, (SEC_DIALOG_STRING_BASE + 875), "\
Accept this Certificate Authority for Certifying network sites")

ResDef(XP_CA_CERT_EMAIL_OK_STRING, (SEC_DIALOG_STRING_BASE + 876), "\
Accept this Certificate Authority for Certifying e-mail users")

ResDef(XP_CA_CERT_OBJECT_SIGNING_OK_STRING, (SEC_DIALOG_STRING_BASE + 877), "\
Accept this Certificate Authority for Certifying software developers")

ResDef(XP_CERT_MULTI_SUBJECT_SELECT_STRING, (SEC_DIALOG_STRING_BASE + 878), "\
%0%<p>%1%")

ResDef(XP_CERT_MULTI_SUBJECT_SELECT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 879), "\
Select A Certificate")

ResDef(XP_CERT_SELECT_EDIT_STRING, (SEC_DIALOG_STRING_BASE + 880), "\
Please select a certificate to edit:<p>")

ResDef(XP_CERT_SELECT_DEL_STRING, (SEC_DIALOG_STRING_BASE + 881), "\
Please select a certificate to delete:<p>")

ResDef(XP_CERT_SELECT_VIEW_STRING, (SEC_DIALOG_STRING_BASE + 882), "\
Please select a certificate to view:<p>")

ResDef(XP_CERT_SELECT_VERIFY_STRING, (SEC_DIALOG_STRING_BASE + 883), "\
Please select a certificate to verify:<p>")

ResDef(XP_DEL_EMAIL_CERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 884), "\
Delete An E-mail Certificate")

ResDef(XP_DELETE_EMAIL_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 885), "\
Are you sure that you want to delete this E-mail Certificate?<p>%0%")

ResDef(XP_SET_EMAIL_CERT_STRING, (SEC_DIALOG_STRING_BASE + 886), "\
...
ResDef(SEC_PK11_MANUFACTURER, (SEC_DIALOG_STRING_BASE + 937), "\
Netscape Communications Corp    ")

#ifdef MOZ_LITE
ResDef(SEC_PK11_LIBARARY, (SEC_DIALOG_STRING_BASE + 938), "\
Navigator Internal Crypto Svc   ")
#else
ResDef(SEC_PK11_LIBARARY, (SEC_DIALOG_STRING_BASE + 938), "\
...
#ifdef MOZ_LITE
ResDef(SEC_PK11_TOKEN, (SEC_DIALOG_STRING_BASE + 939), "\
Navigator Generic Crypto Svcs   ")
#else
ResDef(SEC_PK11_TOKEN, (SEC_DIALOG_STRING_BASE + 939), "\
...
#ifdef MOZ_LITE
ResDef(SEC_PK11_PRIV_TOKEN, (SEC_DIALOG_STRING_BASE + 940), "\
Navigator Certificate DB        ")
#else
ResDef(SEC_PK11_PRIV_TOKEN, (SEC_DIALOG_STRING_BASE + 940), "\
 ...
 * Communicator will revert to it's old strings */
#ifdef MOZ_LITE
ResDef(SEC_PK11_SLOT, (SEC_DIALOG_STRING_BASE + 946), "\
Navigator Internal Cryptographic Services Version 4.0           ")
#else
ResDef(SEC_PK11_SLOT, (SEC_DIALOG_STRING_BASE + 946), "\
...
#ifdef MOZ_LITE
ResDef(SEC_PK11_PRIV_SLOT, (SEC_DIALOG_STRING_BASE + 947), "\
Navigator User Private Key and Certificate Services             ")
#else
ResDef(SEC_PK11_PRIV_SLOT, (SEC_DIALOG_STRING_BASE + 947), "\
Communicator User Private Key and Certificate Services          ")
#endif

ResDef(SEC_PK11_FIPS_SLOT, (SEC_DIALOG_STRING_BASE + 953), "\
Netscape Internal FIPS-140-1 Cryptographic Services             ")

ResDef(SEC_PK11_FIPS_PRIV_SLOT, (SEC_DIALOG_STRING_BASE + 954), "\
Netscape FIPS-140-1 User Private Key Services                   ")

ResDef(XP_VERIFY_CERT_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 955), "\
Verification of the selected certificate failed for the following \
reasons:<p>%0%")

ResDef(XP_VERIFYCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 956), "\
Verify A Certificate")

ResDef(XP_VERIFY_CERT_OK_DIALOG_STRING, (SEC_DIALOG_STRING_BASE + 962), "\
The Certificate has been successfully verified.")

ResDef(XP_VERIFY_ERROR_EXPIRED, (SEC_DIALOG_STRING_BASE + 963), "\
Certificate has expired")

ResDef(XP_VERIFY_ERROR_NOT_CERTIFIED, (SEC_DIALOG_STRING_BASE + 964), "\
Not certified for %s")

ResDef(XP_VERIFY_ERROR_NOT_TRUSTED, (SEC_DIALOG_STRING_BASE + 965), "\
Certificate not trusted")

ResDef(XP_VERIFY_ERROR_NO_CA, (SEC_DIALOG_STRING_BASE + 966), "\
Unable to find Certificate Authority")

ResDef(XP_VERIFY_ERROR_BAD_SIG, (SEC_DIALOG_STRING_BASE + 967), "\
Certificate signature is invalid")

ResDef(XP_VERIFY_ERROR_BAD_CRL, (SEC_DIALOG_STRING_BASE + 968), "\
Certificate Revocation List is invalid")

ResDef(XP_VERIFY_ERROR_REVOKED, (SEC_DIALOG_STRING_BASE + 969), "\
Certificate has been revoked")

ResDef(XP_VERIFY_ERROR_NOT_CA, (SEC_DIALOG_STRING_BASE + 970), "\
Not a valid Certificate Authority")

ResDef(XP_VERIFY_ERROR_INTERNAL_ERROR, (SEC_DIALOG_STRING_BASE + 971), "\
Internal Error")

ResDef(XP_VERIFY_ERROR_SIGNING, (SEC_DIALOG_STRING_BASE + 972), "\
Digital Signing")

ResDef(XP_VERIFY_ERROR_ENCRYPTION, (SEC_DIALOG_STRING_BASE + 973), "\
Encryption")

ResDef(XP_VERIFY_ERROR_CERT_SIGNING, (SEC_DIALOG_STRING_BASE + 974), "\
Certificate Signing")

ResDef(XP_VERIFY_ERROR_CERT_UNKNOWN_USAGE, (SEC_DIALOG_STRING_BASE + 975), "\
Unknown Usage")

ResDef(XP_VERIFY_ERROR_EMAIL_CA, (SEC_DIALOG_STRING_BASE + 976), "\
E-Mail Certification")

ResDef(XP_VERIFY_ERROR_SSL_CA, (SEC_DIALOG_STRING_BASE + 977), "\
Internet Site Certification")

ResDef(XP_VERIFY_ERROR_OBJECT_SIGNING_CA, (SEC_DIALOG_STRING_BASE + 978), "\
Software Developer Certification")

ResDef(XP_VERIFY_ERROR_EMAIL, (SEC_DIALOG_STRING_BASE + 979), "\
E-Mail")

ResDef(XP_VERIFY_ERROR_SSL, (SEC_DIALOG_STRING_BASE + 980), "\
Internet Site")

ResDef(XP_VERIFY_ERROR_OBJECT_SIGNING, (SEC_DIALOG_STRING_BASE + 981), "\
Software Developer")


ResDef(XP_DIALOG_NULL_STRINGS, (SEC_DIALOG_STRING_BASE + 987), "\
%0%")

ResDef(XP_FIPS_MESSAGE_1, (SEC_DIALOG_STRING_BASE + 988), "\
This will replace the Netscape internal module with the Netscape FIPS-140-1 \
cryptographic module.\n\nThe FIPS-140-1 cryptographic module limits security ")

ResDef(XP_FIPS_MESSAGE_2, (SEC_DIALOG_STRING_BASE + 989), "\
...
#ifdef MOZ_LITE
ResDef(XP_INT_MODULE_MESSAGE_1, (SEC_DIALOG_STRING_BASE + 995), "\
This will replace the FIPS-140-1 cryptographic module with the Netscape \
internal module.\n\nThis means that Navigator will no longer be FIPS-140-1 \
compliant (security ")
#else
ResDef(XP_INT_MODULE_MESSAGE_1, (SEC_DIALOG_STRING_BASE + 995), "\
This will replace the FIPS-140-1 cryptographic module with the Netscape \
...
ResDef(XP_INT_MODULE_MESSAGE_2, (SEC_DIALOG_STRING_BASE + 996), "\
functions to those approved by the United States Federal Government's internal \
standards).\n\nDo you wish to delete the FIPS-140-1 module, anyway?")

ResDef(XP_SEC_FETCH, (SEC_DIALOG_STRING_BASE + 997), "\
Search")

ResDef(XP_DIALOG_FETCH_TITLE, (SEC_DIALOG_STRING_BASE + 998), "\
Search Directory for Certificates")

ResDef(XP_DIALOG_FETCH_CANCEL_BUTTON_STRINGS, (SEC_DIALOG_STRING_BASE + 1004), "\
<div align=right><input type=\042button\042 name=\042button\042 \
...
#ifdef MOZ_LITE
ResDef(XP_DIALOG_FETCH_STRINGS, (SEC_DIALOG_STRING_BASE + 1005), "\
Navigator will search network Directories for the Security Certificates \
...
ResDef(XP_DIALOG_FETCH_STRINGS2, (SEC_DIALOG_STRING_BASE + 1006), "\
...
ResDef(XP_DIALOG_FETCH_STRINGS3, (SEC_DIALOG_STRING_BASE + 1007), "\
</select></td>\
</tr>\
%-cont-%")

ResDef(XP_DIALOG_FETCH_STRINGS4, (SEC_DIALOG_STRING_BASE + 1008), "\
<tr>\
...
ResDef(XP_DIALOG_ALL_DIRECTORIES, (SEC_DIALOG_STRING_BASE + 1014), "\
All Directories")

ResDef(XP_DIALOG_FETCH_RESULTS_TITLE, (SEC_DIALOG_STRING_BASE + 1015), "\
Search Results")

ResDef(XP_DIALOG_FETCH_RESULTS_STRINGS, (SEC_DIALOG_STRING_BASE + 1016), "\
...
ResDef(XP_DIALOG_FETCH_NOT_FOUND_STRINGS, (SEC_DIALOG_STRING_BASE + 1017), "\
Certificates for the following E-Mail users were not found in the \
directory:<br>")

ResDef(XP_DIALOG_PUBLISH_CERT_TITLE, (SEC_DIALOG_STRING_BASE + 1018), "\
Send Your E-Mail Certificate To A Directory")

ResDef(XP_DIALOG_PUBLISH_CERT_STRINGS, (SEC_DIALOG_STRING_BASE + 1019), "\
...
#ifdef MOZ_LITE
ResDef(XP_DIALOG_PUBLISH_CERT_STRINGS2, (SEC_DIALOG_STRING_BASE + 1020), "\
Navigator will send your Security Certificate to a network Directory \
...
ResDef(XP_STATUS_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 1021), "\
%0%%1%%2%%3%%4%")

#ifdef MOZ_LITE
ResDef(XP_DIALOG_FETCH2_STRINGS, (SEC_DIALOG_STRING_BASE + 1022), "\
Navigator will search a Directory for the Security \
...
ResDef(XP_DIALOG_FETCH2_STRINGS2, (SEC_DIALOG_STRING_BASE + 1023), "\
...
ResDef(XP_DIALOG_FETCH2_STRINGS3, (SEC_DIALOG_STRING_BASE + 1024), "\
</select></td>\
</tr>\
<tr>\
...
ResDef(XP_SENDING_TO_DIRECTORY, (SEC_DIALOG_STRING_BASE + 1075), "\
Sending to Directory")

ResDef(XP_SEARCHING_DIRECTORY, (SEC_DIALOG_STRING_BASE + 1076), "\
Searching Directory")

ResDef(XP_DIRECTORY_PASSWORD, (SEC_DIALOG_STRING_BASE + 1077), "\
Enter Password for Directory")

ResDef(XP_DIRECTORY_ERROR, (SEC_DIALOG_STRING_BASE + 1078), "\
An error occurred when communicating with the Directory")

#ifdef MOZ_LITE
ResDef(XP_KEY_GEN_MOREINFO_STRINGS,	(SEC_DIALOG_STRING_BASE + 1079), "\
%sec-banner-begin%%0%%sec-banner-end%\
Navigator is about to generate a Private Key for you.  It will be used \
...
#ifdef MOZ_LITE
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 1080), "\
now requesting to identify you to Web\
Sites and via Email.  You Private Key never leaves your computer, and if you \
choose, will be protected by a Navigator password.<P>\
%-cont-%")
#else
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 1080), "\
now requesting to identify you to Web\
...
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_2,	(SEC_DIALOG_STRING_BASE + 1081), "\
...
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_3,	(SEC_DIALOG_STRING_BASE + 1082), "\
Do not give others your password, because that would allow them to use your \
Certificate to impersonate you.<P>\
%-cont-%")

#ifdef MOZ_LITE
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_4,	(SEC_DIALOG_STRING_BASE + 1083), "\
Navigator uses a complex mathematical operation to generate your private \
...
#ifdef MOZ_LITE
ResDef(XP_KEY_GEN_MOREINFO_STRINGS_5,	(SEC_DIALOG_STRING_BASE + 1084), "\
Navigator during this process, it will not create your key, and you will \
...
ResDef(XP_PW_MOREINFO_STRINGS,		(SEC_DIALOG_STRING_BASE + 1090), "\
%sec-banner-begin%%0%%sec-banner-end%\
Passwords are particularly important if you are in an environment where other \
%-cont-%")

ResDef(XP_PW_MOREINFO_STRINGS_1,	(SEC_DIALOG_STRING_BASE + 1091), "\
people have access to your computer, either physically or over a network.  \
Do not give others your password, because that would allow them to use your \
%-cont-%")

ResDef(XP_PW_MOREINFO_STRINGS_2,	(SEC_DIALOG_STRING_BASE + 1092), "\
...
ResDef(XP_PKCS12_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 1098), "\
Select a Card or Database")

ResDef(XP_PKCS12_SELECT_DIALOG_STRINGS, (SEC_DIALOG_STRING_BASE + 1099), "\
Select the card or database you wish to import certificates to: <BR> \
<SELECT NAME=\042tokenName\042 SIZE=10>%0%</SELECT>")

ResDef(XP_VERIFY_NOT_FORTEZZA_CA, (SEC_DIALOG_STRING_BASE + 1100), "\
Not a valid FORTEZZA Certificate Authority")

ResDef(XP_VERIFY_NO_PUBLIC_KEY, (SEC_DIALOG_STRING_BASE + 1101), "\
Certificate does not have a Recognized Public Key")

#ifdef XP_MAC
ResDef(XP_PREENC_SAVE_PROMPT, (SEC_DIALOG_STRING_BASE + 1102), "\
...
ResDef(XP_SEC_ERROR_PWD, (SEC_DIALOG_STRING_BASE + 1103), "\
Successive login failures may disable this card or database. \
Password is invalid. Retry?\n\
    %s\n")

ResDef(XP_VERIFY_NO_KRL, (SEC_DIALOG_STRING_BASE + 1104),
"No key revocation list for the certificate has been found.\n\
You must load the key revocation list before continuing.")

ResDef(XP_VERIFY_KRL_EXPIRED, (SEC_DIALOG_STRING_BASE + 1105),
"The key revocation list for the certificate has expired.\n\
Reload a new key revocation list.")

ResDef(XP_VERIFY_KRL_BAD_SIGNATURE, (SEC_DIALOG_STRING_BASE + 1106),
"The key revocation list for the certificate has an invalid signature.\n\
Reload a new key revocation list.")

ResDef(XP_VERIFY_REVOKED_KEY, (SEC_DIALOG_STRING_BASE + 1107),
"The key for the certificate has been revoked.")

ResDef(XP_VERIFY_KRL_INVALID, (SEC_DIALOG_STRING_BASE + 1108),
"The key revocation list has an invalid format.")

ResDef(XP_VERIFY_BAD_CERT_DOMAIN, (SEC_DIALOG_STRING_BASE + 1109),
...
ResDef(XP_SIGN_TEXT_TITLE_STRING,	(SEC_DIALOG_STRING_BASE + 1160), "\
Digital Signature")

ResDef(XP_SIGN_TEXT_DIALOG_STRINGS,	(SEC_DIALOG_STRING_BASE + 1161), "\
...
ResDef(XP_SIGN_TEXT_ASK_DIALOG_STRINGS,	(SEC_DIALOG_STRING_BASE + 1200), "\
The site '%0%' has requested that you sign the following message:\
<br><pre><dl><dd><tt>%1%</dl></tt></pre><br>Please select a certificate \
%-cont-%")

ResDef(XP_SIGN_TEXT_ASK_DIALOG_STRINGS2, (SEC_DIALOG_STRING_BASE + 1201), "\
...
ResDef(XP_EDITPCERT_TITLE_STRING, (SEC_DIALOG_STRING_BASE + 1202), "\
View/Edit A Personal Certificate")


ResDef(XP_EDIT_PCERT_STRINGS, (SEC_DIALOG_STRING_BASE + 1203), "\
%0%<hr><div><b>This email user's certificate does not have a trusted issuer.</b> \
<br>You may decide to directly trust this certificate to permit the \
%-cont-%")

ResDef(XP_EDIT_PCERT_STRINGS_1, (SEC_DIALOG_STRING_BASE + 1204), "\
exchange of<br>signed and encrypted e-mail with this user. <p>\
%-cont-%")

ResDef(XP_EDIT_PCERT_STRINGS_2, (SEC_DIALOG_STRING_BASE + 1205), "\
...
ResDef(XP_EDIT_PCERT_STRINGS_3, (SEC_DIALOG_STRING_BASE + 1206), "\
 listed above is the same<br>as the one he or she has.<p><input \
type=radio name=dirtrust value=no %1%>Do not trust this \
certificate.<br> %-cont-%")

ResDef(XP_EDIT_PCERT_STRINGS_4, (SEC_DIALOG_STRING_BASE + 1207), "\
<input type=radio name=dirtrust value=yes %2%>Trust this \
certificate even though it does not have a trusted issuer.</div>")

ResDef(XP_BANNER_FONTFACE_INFO_STRING, (SEC_DIALOG_STRING_BASE + 1213), "\
<font face=\042Impress BT, Verdana, Arial, Helvetica, sans-serif\042 \
point-size=16>")

ResDef(XP_DIALOG_STYLEINFO_STRING, (SEC_DIALOG_STRING_BASE + 1214), "\
<STYLE TYPE=\042text/css\042> DIV { FONT-FAMILY: \042Prima Sans BT\042,\
 Verdana, Arial, Helvetica, Lucida; FONT-SIZE: 10pt;} TD { FONT-FAMILY: \
\042PrimaSans BT\042, Verdana, Arial, Helvetica, Lucida; %-cont-%")

ResDef(XP_DIALOG_STYLEINFO_STRING_1, (SEC_DIALOG_STRING_BASE + 1215), "\
FONT-SIZE: 10pt;} BODY { FONT-FAMILY: \042Prima Sans BT\042, Verdana, \
Arial, Helvetica, Lucida; FONT-SIZE: 10 pt;} %-cont-%")
 
ResDef(XP_DIALOG_STYLEINFO_STRING_2, (SEC_DIALOG_STRING_BASE + 1216), "\
H1, H2, H3 { font-weight: 700;} H1 { FONT-SIZE: 16PT; \
} H2 {FONT-SIZE: 14PT;} </STYLE>" )
 ...
 */
ResDef(SA_STRINGS_BEGIN, (SEC_DIALOG_STRING_BASE + 1500), "")
ResDef(SA_VIEW_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1501), "View")
ResDef(SA_EDIT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1502), "Edit")
ResDef(SA_VERIFY_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1503), "Verify")
ResDef(SA_DELETE_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1504), "Delete")
ResDef(SA_EXPORT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1505), "Export")
ResDef(SA_EXPIRED_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1506),
 "Delete Expired")
ResDef(SA_REMOVE_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1507), "Remove")
ResDef(SA_GET_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1508),
 "Get a Certificate...")
ResDef(SA_GET_CERTS_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1509),
 "Get Certificates...")
ResDef(SA_IMPORT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1510),
 "Import a Certificate...")
ResDef(SA_VIEW_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1511),
 "View Certificate")
ResDef(SA_EDIT_PRIVS_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1512),
 "Edit Privileges")
ResDef(SA_VIEW_EDIT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1513), "View/Edit")
ResDef(SA_ADD_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1514), "Add")
ResDef(SA_LOGOUT_ALL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1515),
 "Logout All")
ResDef(SA_OK_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1516), "OK")
ResDef(SA_CANCEL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1517), "Cancel")
ResDef(SA_HELP_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1518), "Help")
ResDef(SA_SEARCH_DIR_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1519),
 "Search Directory")
ResDef(SA_SEND_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1520),
 "Send Certificate To Directory")
ResDef(SA_PAGE_INFO_LABEL, (SEC_DIALOG_STRING_BASE + 1521), "Open Page Info")
ResDef(SA_SECINFO_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1522),
 "Security Info")
ResDef(SA_PASSWORDS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1523), "Passwords")
ResDef(SA_NAVIGATOR_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1524), "Navigator")
ResDef(SA_MESSENGER_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1525), "Messenger")
ResDef(SA_APPLETS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1526),
 "Java/JavaScript")
ResDef(SA_CERTS_INTRO_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1527),
 "Certificates")
ResDef(SA_YOURS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1528), "Yours")
ResDef(SA_PEOPLE_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1529), "People")
ResDef(SA_SITES_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1530), "Web Sites")
ResDef(SA_DEVELOPERS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1531),
 "Software Developers")
ResDef(SA_SIGNERS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1532), "Signers")
ResDef(SA_MODULES_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 1533),
 "Cryptographic Modules")
ResDef(SA_SECINFO_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1534),
 "Security Info")
ResDef(SA_PASSWORDS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1535), "Passwords")
ResDef(SA_NAVIGATOR_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1536), "Navigator")
ResDef(SA_MESSENGER_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1537), "Messenger")
ResDef(SA_APPLETS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1538),
 "Java/JavaScript")
ResDef(SA_CERTS_INTRO_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1539),
 "Certificates")
ResDef(SA_YOURS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1540),
 "Your Certificates")
ResDef(SA_PEOPLE_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1541),
 "Other People's Certificates")
ResDef(SA_SITES_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1542),
 "Web Sites' Certificates")
ResDef(SA_DEVELOPERS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1543),
 "Software Developers' Certificates")
ResDef(SA_SIGNERS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1544),
 "Certificate Signers' Certificates")
ResDef(SA_MODULES_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 1545),
 "Cryptographic Modules")
ResDef(SA_ENTER_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 1546),
 "Entering an encrypted site")
ResDef(SA_LEAVE_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 1547),
 "Leaving an encrypted site")
ResDef(SA_MIXED_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 1548),
 "Viewing a page with an encrypted/unencrypted mix")
ResDef(SA_SEND_CLEAR_LABEL, (SEC_DIALOG_STRING_BASE + 1549),
 "Sending unencrypted information to a Site")
ResDef(SA_SSL_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 1550),
 "<B>Certificate to identify you to a web site:</B>")
ResDef(SA_ASK_SA_EVERY_TIME_LABEL, (SEC_DIALOG_STRING_BASE + 1551),
 "Ask Every Time")
ResDef(SA_SELECT_AUTO_LABEL, (SEC_DIALOG_STRING_BASE + 1552),
 "Select Automatically")
ResDef(SA_SSL_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 1553),
 "<B>Advanced Security (SSL) Configuration:</B>")
ResDef(SA_SSL2_ENABLE_LABEL, (SEC_DIALOG_STRING_BASE + 1554),
 "Enable SSL (Secure Sockets Layer) v2")
ResDef(SA_SSL2_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 1555),
 "Configure SSL v2")
ResDef(SA_SSL3_ENABLE_LABEL, (SEC_DIALOG_STRING_BASE + 1556),
 "Enable SSL (Secure Sockets Layer) v3")
ResDef(SA_SSL3_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 1557),
 "Configure SSL v3")
ResDef(SA_SMIME_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 1558),
 "<B>Certificate for your Signed and Encrypted Messages:</B>")
ResDef(SA_SMIME_NO_CERTS_BLURB, (SEC_DIALOG_STRING_BASE + 1559),
 "<B>(You have no email certificates.)</B>")
ResDef(SA_SMIME_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 1560),
 "Select S/MIME Ciphers")
ResDef(SA_CHANGE_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 1561),
 "Change Password")
ResDef(SA_SET_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 1562), "Set Password")
ResDef(SA_ASK_FOR_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 1563),
 "<B>Communicator will ask for this Password:</B>")
ResDef(SA_ONCE_PER_SESSION_LABEL, (SEC_DIALOG_STRING_BASE + 1564),
 "The first time your certificate is needed")
ResDef(SA_EVERY_TIME_LABEL, (SEC_DIALOG_STRING_BASE + 1565),
 "Every time your certificate is needed")
ResDef(SA_AFTER_LABEL, (SEC_DIALOG_STRING_BASE + 1566), "After")
ResDef(SA_MINUTES_LABEL, (SEC_DIALOG_STRING_BASE + 1567),
 "minutes of inactivity")
ResDef(SA_COMPOSE_ENCRYPT_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1568),
 "Encrypting Message")
ResDef(SA_COMPOSE_SIGN_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1569),
 "Signing Message")
ResDef(SA_MESSAGE_ENCRYPT_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1570),
 "Encrypted Message")
ResDef(SA_MESSAGE_SIGN_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1571),
 "Signed Message")
ResDef(SA_CAN_ENCRYPT, (SEC_DIALOG_STRING_BASE + 1572),
 "This message <B>can be encrypted</B> when it is sent.")
ResDef(SA_SEND_ENCRYPT_DESC, (SEC_DIALOG_STRING_BASE + 1573),
...
ResDef(SA_ENCRYPT_THIS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 1574),
 "Encrypt this message.")
ResDef(SA_SEND_CLEAR_WARN_DESC, (SEC_DIALOG_STRING_BASE + 1575),
...
postcard instead of an envelope. Other people may be able to read your\
 message.")
ResDef(SA_NO_RECIPIENTS_DESC, (SEC_DIALOG_STRING_BASE + 1576),
 "You must have at least one recipient entered for this message.")
ResDef(SA_CANNOT_ENCRYPT_HEAD, (SEC_DIALOG_STRING_BASE + 1577),
 "This message <B>cannot be encrypted</B> when it is sent because")
ResDef(SA_CERT_MISSING_TAIL, (SEC_DIALOG_STRING_BASE + 1578),
 " has no Security Certificate.")
ResDef(SA_CERT_HAS_EXP_TAIL, (SEC_DIALOG_STRING_BASE + 1579),
 " has an expired Security Certificate.")
ResDef(SA_CERT_HAS_REVOKE_TAIL, (SEC_DIALOG_STRING_BASE + 1580),
 " has a revoked Security Certificate.")
ResDef(SA_CERT_NO_ALIAS_TAIL, (SEC_DIALOG_STRING_BASE + 1581),
 " in Alias has no Security Certificate.")
ResDef(SA_CERT_NEWSGROUP_TAIL, (SEC_DIALOG_STRING_BASE + 1582),
 " is a Discussion Group.")
ResDef(SA_CERT_INVALID_TAIL, (SEC_DIALOG_STRING_BASE + 1583),
 " has an invalid Security Certificate.")
ResDef(SA_CERT_UNTRUSTED_TAIL, (SEC_DIALOG_STRING_BASE + 1584),
 " has a Security Certificate that is marked as Untrusted.")
ResDef(SA_CERT_ISSUER_UNTRUSTED_TAIL, (SEC_DIALOG_STRING_BASE + 1585),
 " has a Security Certificate Issuer that is marked as Untrusted.")
ResDef(SA_CERT_ISSUER_UNKNOWN_TAIL, (SEC_DIALOG_STRING_BASE + 1586),
 " has an unknown Security Certificate  Issuer.")
ResDef(SA_CERT_UNKNOWN_ERROR_TAIL, (SEC_DIALOG_STRING_BASE + 1587),
 ": unknown certificate error.")
ResDef(SA_HOW_TO_GET_THEIR_CERT_1, (SEC_DIALOG_STRING_BASE + 1588),
...
ResDef(SA_HOW_TO_GET_THEIR_CERT_2, (SEC_DIALOG_STRING_BASE + 1589),
...
being sent.")
ResDef(SA_WAS_NOT_ENCRYPTED, (SEC_DIALOG_STRING_BASE + 1598),
 ...
 was being sent.")
ResDef(SA_WAS_ENCRYPTED_FOR_OTHER_1, (SEC_DIALOG_STRING_BASE + 1599),
...
ResDef(SA_WAS_ENCRYPTED_FOR_OTHER_2, (SEC_DIALOG_STRING_BASE + 1600),
...
ResDef(SA_ENCRYPTION_ALGORITHM_WAS, (SEC_DIALOG_STRING_BASE + 1601),
 "The algorithm used was ")
ResDef(SA_WAS_SIGNED_HEAD, (SEC_DIALOG_STRING_BASE + 1602),
 "This message <B>was digitally signed</B> by ")
ResDef(SA_INCLUDED_CERT_DESC_HEAD, (SEC_DIALOG_STRING_BASE + 1603),
 "This message included the Security Certificate for ")
ResDef(SA_WAS_SIGNED_AT, (SEC_DIALOG_STRING_BASE + 1604), " on ")
ResDef(SA_INCLUDED_CERT_DESC_SIGNED_AT, (SEC_DIALOG_STRING_BASE + 1605),
 ", and was signed on ")
ResDef(SA_WAS_SIGNED_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 1606),
 "To check the Certificate, press the ``View/Edit'' button. <P>This\
 Certificate has automatically been added to your list of ")
ResDef(SA_WAS_SIGNED_DESC_TAIL_2, (SEC_DIALOG_STRING_BASE + 1607),
 "People's Certificates to make it possible for you to send secure mail\
 to this person.")
ResDef(SA_WAS_NOT_SIGNED, (SEC_DIALOG_STRING_BASE + 1608),
 "This message <B>was not digitally signed</B>. <P>It is impossible to\
 verify that this message actually came from the sender.")
ResDef(SA_SIG_INVALID, (SEC_DIALOG_STRING_BASE + 1609),
...
ResDef(SA_ENCRYPTION_INVALID, (SEC_DIALOG_STRING_BASE + 1610),
 "<B>This message cannot be decrypted.</B> ")
ResDef(SA_SIGN_ERROR_INTRO, (SEC_DIALOG_STRING_BASE + 1611), "The error was: ")
ResDef(SA_SIG_TAMPERED_1, (SEC_DIALOG_STRING_BASE + 1612),
...
ResDef(SA_SIG_TAMPERED_2, (SEC_DIALOG_STRING_BASE + 1613),
...
ResDef(SA_NEWS_NOT_ENCRYPTED, (SEC_DIALOG_STRING_BASE + 1620),
 ...
 are reading them.")
ResDef(SA_NAV_ENCRYPTION_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1621),
 "Encryption")
ResDef(SA_NAV_VERIFICATION_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1622),
 "Verification")
ResDef(SA_NAV_NO_ENCRYPT_DESC_1, (SEC_DIALOG_STRING_BASE + 1623),
 "This page <B>was not encrypted</B>. This means it was possible for\
 other people to view this page when it was loaded. It ")
ResDef(SA_NAV_NO_ENCRYPT_DESC_2, (SEC_DIALOG_STRING_BASE + 1624),
...
ResDef(SA_NAV_ENCRYPT_DESC_3, (SEC_DIALOG_STRING_BASE + 1627),
 ...
 Page Info</B>.")
ResDef(SA_NAV_NO_ENCRYPT_MIX_DESC_1, (SEC_DIALOG_STRING_BASE + 1628),
 "This page <B>was not encrypted</B>, but some of the files it contains\
 were encrypted. This means it was difficult for ")
ResDef(SA_NAV_NO_ENCRYPT_MIX_DESC_2, (SEC_DIALOG_STRING_BASE + 1629),
 "other people to view the encrypted files when the page was loaded. It\
 also means that you cannot check the ")
ResDef(SA_NAV_NO_ENCRYPT_MIX_DESC_3, (SEC_DIALOG_STRING_BASE + 1630),
 "identity of the web site for the page.<P>For complete details on all\
 the files on this page, click <B>Open Page Info</B>.")
ResDef(SA_NAV_ENCRYPT_MIX_DESC_1, (SEC_DIALOG_STRING_BASE + 1631),
 "This page <B>was encrypted</B>. This means it was difficult for other\
 people to view this page when it was loaded. You can ")
ResDef(SA_NAV_ENCRYPT_MIX_DESC_2, (SEC_DIALOG_STRING_BASE + 1632),
 "examine your copy of the certificate for this page and the identity of\
 the web site. To see the certificate for ")
ResDef(SA_NAV_ENCRYPT_MIX_DESC_3, (SEC_DIALOG_STRING_BASE + 1633),
 "this web site, click <B>View Certificate</B>.<P>However, some of the\
 files on this page <B>were not ")
ResDef(SA_NAV_ENCRYPT_MIX_DESC_4, (SEC_DIALOG_STRING_BASE + 1634),
 "encrypted</B>. This means that it was possible for other people to view \
those files when they were loaded. For complete ")
ResDef(SA_NAV_ENCRYPT_MIX_DESC_5, (SEC_DIALOG_STRING_BASE + 1635),
 "details on all the files on this page and their certificates, click\
 <B>Open Page Info</B>.")
ResDef(SA_NAV_VERIFY_CERT_DESC, (SEC_DIALOG_STRING_BASE + 1636),
 "Take a look at the page's Certificate.")
ResDef(SA_NAV_VERIFY_DOMAIN_DESC, (SEC_DIALOG_STRING_BASE + 1637),
 "Make sure that this is the site you think it is. This page comes from\
 the site: ")
ResDef(SA_NAV_VERIFY_MISSING_DESC_1, (SEC_DIALOG_STRING_BASE + 1638),
 "The following elements are missing from this window: ")
ResDef(SA_NAV_VERIFY_MISSING_DESC_2, (SEC_DIALOG_STRING_BASE + 1639),
 ". This means that you may be missing important information.")
ResDef(SA_NAV_INFO_MENUBAR_NAME, (SEC_DIALOG_STRING_BASE + 1640),
 "the menubar")
ResDef(SA_NAV_INFO_TOOLBAR_NAME, (SEC_DIALOG_STRING_BASE + 1641),
 "the toolbar")
ResDef(SA_NAV_INFO_PERSONALBAR_NAME, (SEC_DIALOG_STRING_BASE + 1642),
 "the personal toolbar")
ResDef(SA_NAV_INFO_LOCATION_NAME, (SEC_DIALOG_STRING_BASE + 1643),
 "the location bar")
ResDef(SA_NAV_INFO_STATUS_NAME, (SEC_DIALOG_STRING_BASE + 1644),
 "the status bar")
ResDef(SA_NAV_VERIFY_JAVA_DESC_1, (SEC_DIALOG_STRING_BASE + 1645),
 "This window was created by a Java Application (from ")
ResDef(SA_NAV_VERIFY_JAVA_DESC_2, (SEC_DIALOG_STRING_BASE + 1646),
 "). This application has some control over this window and may influence \
what you see.")
ResDef(SA_NAV_VERIFY_JS_DESC_1, (SEC_DIALOG_STRING_BASE + 1647),
 "This window was created by a JavaScript Application (from ")
ResDef(SA_NAV_VERIFY_JS_DESC_2, (SEC_DIALOG_STRING_BASE + 1648),
 "). This application has some control over this window and may influence \
what you see.")
ResDef(SA_NOT_ME_SUBTITLE, (SEC_DIALOG_STRING_BASE + 1649),
 "<B><H2>There is no Security Info for this window.</H2></B>")
ResDef(SA_NOT_ME_DESC_1, (SEC_DIALOG_STRING_BASE + 1650),
 "Security Info is available for Browser, Messenger Message, and\
 Discussion Message windows. ")
ResDef(SA_NOT_ME_DESC_2, (SEC_DIALOG_STRING_BASE + 1651),
 "<P>If you wish to change Security settings or preferences, use the tabs \
on the left to switch between different areas.")
ResDef(SA_CERTS_INTRO_STRING_1, (SEC_DIALOG_STRING_BASE + 1652),
...
A file that identifies a person or organization. Communicator uses\
 certificates to ")
ResDef(SA_CERTS_INTRO_STRING_2, (SEC_DIALOG_STRING_BASE + 1653),
...
ResDef(SA_CERTS_INTRO_STRING_3, (SEC_DIALOG_STRING_BASE + 1654),
...
ResDef(SA_YOUR_CERTS_DESC_2, (SEC_DIALOG_STRING_BASE + 1659),
...
ResDef(SA_YOUR_CERTS_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 1660),
...
ResDef(SA_SMIME_DESC, (SEC_DIALOG_STRING_BASE + 1668),
...
ResDef(SA_SMIME_PREF_DESC, (SEC_DIALOG_STRING_BASE + 1669),
 "<B>Sending Signed/Encrypted Mail:</B>")
ResDef(SA_ENCRYPT_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 1670),
 "Encrypt mail messages, when it is possible")
ResDef(SA_SIGN_MAIL_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 1671),
 "Sign mail messages, when it is possible")
ResDef(SA_SIGN_NEWS_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 1672),
 "Sign discussion (news) messages, when it is possible")
ResDef(SA_SMIME_CERT_DESC, (SEC_DIALOG_STRING_BASE + 1673),
 ...
 you encrypted mail.")
ResDef(SA_SMIME_SEND_CERT_DESC, (SEC_DIALOG_STRING_BASE + 1674),
 "Other people could also obtain your certificate from a Directory:")
ResDef(SA_SMIME_NO_CERT_DESC_1, (SEC_DIALOG_STRING_BASE + 1675),
 "If you had one, this certificate would be included with every email\
 message you <B>signed</B>. When other people received it, ")
ResDef(SA_SMIME_NO_CERT_DESC_2, (SEC_DIALOG_STRING_BASE + 1676),
 "it would make it possible for them to send you encrypted mail. (To get\
 a certificate, see the ``Yours'' tab on the left.)")
ResDef(SA_SMIME_CIPHER_HEADING, (SEC_DIALOG_STRING_BASE + 1677),
 "<B>Advanced S/MIME Configuration:</B>")
ResDef(SA_SMIME_CIPHER_DESC, (SEC_DIALOG_STRING_BASE + 1678),
 "Cipher Preferences: ")
ResDef(SA_APPLETS_DESC_1, (SEC_DIALOG_STRING_BASE + 1679),
...
ResDef(SA_APPLETS_DESC_2, (SEC_DIALOG_STRING_BASE + 1680),
 ...
 web sites.")
ResDef(SA_PASSWORD_DESC_1, (SEC_DIALOG_STRING_BASE + 1681),
 "<B>Your Communicator password will be used to protect your\
 certificates.</B> <P>If you are in an environment where other ")
ResDef(SA_PASSWORD_DESC_2, (SEC_DIALOG_STRING_BASE + 1682),
 "people have access to your computer (either physically or over the\
 network) you should have a Communicator password. <P>")
ResDef(SA_MODULES_DESC, (SEC_DIALOG_STRING_BASE + 1683),
 "<B>Cryptographic Modules:</B>")
ResDef(SA_VIEW_CRL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 1684),
 "View/Edit CRL's")
ResDef(SA_SIGNERS_VIEW_CRL_DESC, (SEC_DIALOG_STRING_BASE + 1685),
 "To view or edit Certificate Revocation Lists press <I>View/Edit\
 CRL's</I>.<p>")
ResDef(SA_WAS_SIGNED_ALT_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 1686),
...
ResDef(SA_PROXY_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 1687),
 "<B>Certificate to use for Proxy Authentication:</B>")
ResDef(SA_NO_PROXY_AUTH_LABEL, (SEC_DIALOG_STRING_BASE + 1688),
 "No Proxy Authentication")
ResDef(SA_STRINGS_END, (SEC_DIALOG_STRING_BASE + 1689), "")
 ...
 */
ResDef(SA_VARNAMES_BEGIN, (SEC_DIALOG_STRING_BASE + 2000), "")
ResDef(SA_VARNAME_VIEW_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2001), "sa_view_button_label")
ResDef(SA_VARNAME_EDIT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2002), "sa_edit_button_label")
ResDef(SA_VARNAME_VERIFY_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2003), "sa_verify_button_label")
ResDef(SA_VARNAME_DELETE_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2004), "sa_delete_button_label")
ResDef(SA_VARNAME_EXPORT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2005), "sa_export_button_label")
ResDef(SA_VARNAME_EXPIRED_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2006), "sa_expired_button_label")
ResDef(SA_VARNAME_REMOVE_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2007), "sa_remove_button_label")
ResDef(SA_VARNAME_GET_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2008), "sa_get_cert_button_label")
ResDef(SA_VARNAME_GET_CERTS_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2009), "sa_get_certs_button_label")
ResDef(SA_VARNAME_IMPORT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2010), "sa_import_button_label")
ResDef(SA_VARNAME_VIEW_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2011), "sa_view_cert_button_label")
ResDef(SA_VARNAME_EDIT_PRIVS_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2012), "sa_edit_privs_button_label")
ResDef(SA_VARNAME_VIEW_EDIT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2013), "sa_view_edit_button_label")
ResDef(SA_VARNAME_ADD_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2014), "sa_add_button_label")
ResDef(SA_VARNAME_LOGOUT_ALL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2015), "sa_logout_all_button_label")
ResDef(SA_VARNAME_OK_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2016), "sa_ok_button_label")
ResDef(SA_VARNAME_CANCEL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2017), "sa_cancel_button_label")
ResDef(SA_VARNAME_HELP_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2018), "sa_help_button_label")
ResDef(SA_VARNAME_SEARCH_DIR_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2019), "sa_search_dir_button_label")
ResDef(SA_VARNAME_SEND_CERT_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2020), "sa_send_cert_button_label")
ResDef(SA_VARNAME_PAGE_INFO_LABEL, (SEC_DIALOG_STRING_BASE + 2021), "sa_page_info_label")
ResDef(SA_VARNAME_SECINFO_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2022), "sa_secinfo_index_label")
ResDef(SA_VARNAME_PASSWORDS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2023), "sa_passwords_index_label")
ResDef(SA_VARNAME_NAVIGATOR_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2024), "sa_navigator_index_label")
ResDef(SA_VARNAME_MESSENGER_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2025), "sa_messenger_index_label")
ResDef(SA_VARNAME_APPLETS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2026), "sa_applets_index_label")
ResDef(SA_VARNAME_CERTS_INTRO_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2027), "sa_certs_intro_index_label")
ResDef(SA_VARNAME_YOURS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2028), "sa_yours_index_label")
ResDef(SA_VARNAME_PEOPLE_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2029), "sa_people_index_label")
ResDef(SA_VARNAME_SITES_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2030), "sa_sites_index_label")
ResDef(SA_VARNAME_DEVELOPERS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2031), "sa_developers_index_label")
ResDef(SA_VARNAME_SIGNERS_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2032), "sa_signers_index_label")
ResDef(SA_VARNAME_MODULES_INDEX_LABEL, (SEC_DIALOG_STRING_BASE + 2033), "sa_modules_index_label")
ResDef(SA_VARNAME_SECINFO_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2034), "sa_secinfo_title_label")
ResDef(SA_VARNAME_PASSWORDS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2035), "sa_passwords_title_label")
ResDef(SA_VARNAME_NAVIGATOR_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2036), "sa_navigator_title_label")
ResDef(SA_VARNAME_MESSENGER_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2037), "sa_messenger_title_label")
ResDef(SA_VARNAME_APPLETS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2038), "sa_applets_title_label")
ResDef(SA_VARNAME_CERTS_INTRO_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2039), "sa_certs_intro_title_label")
ResDef(SA_VARNAME_YOURS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2040), "sa_yours_title_label")
ResDef(SA_VARNAME_PEOPLE_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2041), "sa_people_title_label")
ResDef(SA_VARNAME_SITES_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2042), "sa_sites_title_label")
ResDef(SA_VARNAME_DEVELOPERS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2043), "sa_developers_title_label")
ResDef(SA_VARNAME_SIGNERS_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2044), "sa_signers_title_label")
ResDef(SA_VARNAME_MODULES_TITLE_LABEL, (SEC_DIALOG_STRING_BASE + 2045), "sa_modules_title_label")
ResDef(SA_VARNAME_ENTER_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 2046), "sa_enter_secure_label")
ResDef(SA_VARNAME_LEAVE_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 2047), "sa_leave_secure_label")
ResDef(SA_VARNAME_MIXED_SECURE_LABEL, (SEC_DIALOG_STRING_BASE + 2048), "sa_mixed_secure_label")
ResDef(SA_VARNAME_SEND_CLEAR_LABEL, (SEC_DIALOG_STRING_BASE + 2049), "sa_send_clear_label")
ResDef(SA_VARNAME_SSL_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 2050), "sa_ssl_cert_label")
ResDef(SA_VARNAME_ASK_SA_EVERY_TIME_LABEL, (SEC_DIALOG_STRING_BASE + 2051), "sa_ask_sa_every_time_label")
ResDef(SA_VARNAME_SELECT_AUTO_LABEL, (SEC_DIALOG_STRING_BASE + 2052), "sa_select_auto_label")
ResDef(SA_VARNAME_SSL_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 2053), "sa_ssl_config_label")
ResDef(SA_VARNAME_SSL2_ENABLE_LABEL, (SEC_DIALOG_STRING_BASE + 2054), "sa_ssl2_enable_label")
ResDef(SA_VARNAME_SSL2_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 2055), "sa_ssl2_config_label")
ResDef(SA_VARNAME_SSL3_ENABLE_LABEL, (SEC_DIALOG_STRING_BASE + 2056), "sa_ssl3_enable_label")
ResDef(SA_VARNAME_SSL3_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 2057), "sa_ssl3_config_label")
ResDef(SA_VARNAME_SMIME_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 2058), "sa_smime_cert_label")
ResDef(SA_VARNAME_SMIME_NO_CERTS_BLURB, (SEC_DIALOG_STRING_BASE + 2059), "sa_smime_no_certs_blurb")
ResDef(SA_VARNAME_SMIME_CONFIG_LABEL, (SEC_DIALOG_STRING_BASE + 2060), "sa_smime_config_label")
ResDef(SA_VARNAME_CHANGE_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 2061), "sa_change_password_label")
ResDef(SA_VARNAME_SET_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 2062), "sa_set_password_label")
ResDef(SA_VARNAME_ASK_FOR_PASSWORD_LABEL, (SEC_DIALOG_STRING_BASE + 2063), "sa_ask_for_password_label")
ResDef(SA_VARNAME_ONCE_PER_SESSION_LABEL, (SEC_DIALOG_STRING_BASE + 2064), "sa_once_per_session_label")
ResDef(SA_VARNAME_EVERY_TIME_LABEL, (SEC_DIALOG_STRING_BASE + 2065), "sa_every_time_label")
ResDef(SA_VARNAME_AFTER_LABEL, (SEC_DIALOG_STRING_BASE + 2066), "sa_after_label")
ResDef(SA_VARNAME_MINUTES_LABEL, (SEC_DIALOG_STRING_BASE + 2067), "sa_minutes_label")
ResDef(SA_VARNAME_COMPOSE_ENCRYPT_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2068), "sa_compose_encrypt_subtitle")
ResDef(SA_VARNAME_COMPOSE_SIGN_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2069), "sa_compose_sign_subtitle")
ResDef(SA_VARNAME_MESSAGE_ENCRYPT_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2070), "sa_message_encrypt_subtitle")
ResDef(SA_VARNAME_MESSAGE_SIGN_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2071), "sa_message_sign_subtitle")
ResDef(SA_VARNAME_CAN_ENCRYPT, (SEC_DIALOG_STRING_BASE + 2072), "sa_can_encrypt")
ResDef(SA_VARNAME_SEND_ENCRYPT_DESC, (SEC_DIALOG_STRING_BASE + 2073), "sa_send_encrypt_desc")
ResDef(SA_VARNAME_ENCRYPT_THIS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 2074), "sa_encrypt_this_checkbox_label")
ResDef(SA_VARNAME_SEND_CLEAR_WARN_DESC, (SEC_DIALOG_STRING_BASE + 2075), "sa_send_clear_warn_desc")
ResDef(SA_VARNAME_NO_RECIPIENTS_DESC, (SEC_DIALOG_STRING_BASE + 2076), "sa_no_recipients_desc")
ResDef(SA_VARNAME_CANNOT_ENCRYPT_HEAD, (SEC_DIALOG_STRING_BASE + 2077), "sa_cannot_encrypt_head")
ResDef(SA_VARNAME_CERT_MISSING_TAIL, (SEC_DIALOG_STRING_BASE + 2078), "sa_cert_missing_tail")
ResDef(SA_VARNAME_CERT_HAS_EXP_TAIL, (SEC_DIALOG_STRING_BASE + 2079), "sa_cert_has_exp_tail")
ResDef(SA_VARNAME_CERT_HAS_REVOKE_TAIL, (SEC_DIALOG_STRING_BASE + 2080), "sa_cert_has_revoke_tail")
ResDef(SA_VARNAME_CERT_NO_ALIAS_TAIL, (SEC_DIALOG_STRING_BASE + 2081), "sa_cert_no_alias_tail")
ResDef(SA_VARNAME_CERT_NEWSGROUP_TAIL, (SEC_DIALOG_STRING_BASE + 2082), "sa_cert_newsgroup_tail")
ResDef(SA_VARNAME_CERT_INVALID_TAIL, (SEC_DIALOG_STRING_BASE + 2083), "sa_cert_invalid_tail")
ResDef(SA_VARNAME_CERT_UNTRUSTED_TAIL, (SEC_DIALOG_STRING_BASE + 2084), "sa_cert_untrusted_tail")
ResDef(SA_VARNAME_CERT_ISSUER_UNTRUSTED_TAIL, (SEC_DIALOG_STRING_BASE + 2085), "sa_cert_issuer_untrusted_tail")
ResDef(SA_VARNAME_CERT_ISSUER_UNKNOWN_TAIL, (SEC_DIALOG_STRING_BASE + 2086), "sa_cert_issuer_unknown_tail")
ResDef(SA_VARNAME_CERT_UNKNOWN_ERROR_TAIL, (SEC_DIALOG_STRING_BASE + 2087), "sa_cert_unknown_error_tail")
ResDef(SA_VARNAME_HOW_TO_GET_THEIR_CERT_1, (SEC_DIALOG_STRING_BASE + 2088), "sa_how_to_get_their_cert_1")
ResDef(SA_VARNAME_HOW_TO_GET_THEIR_CERT_2, (SEC_DIALOG_STRING_BASE + 2089), "sa_how_to_get_their_cert_2")
ResDef(SA_VARNAME_CAN_BE_SIGNED, (SEC_DIALOG_STRING_BASE + 2090), "sa_can_be_signed")
ResDef(SA_VARNAME_CANNOT_BE_SIGNED, (SEC_DIALOG_STRING_BASE + 2091), "sa_cannot_be_signed")
ResDef(SA_VARNAME_CANNOT_SIGN_DESC_1, (SEC_DIALOG_STRING_BASE + 2092), "sa_cannot_sign_desc_1")
ResDef(SA_VARNAME_CANNOT_SIGN_DESC_2, (SEC_DIALOG_STRING_BASE + 2093), "sa_cannot_sign_desc_2")
ResDef(SA_VARNAME_CAN_SIGN_DESC, (SEC_DIALOG_STRING_BASE + 2094), "sa_can_sign_desc")
ResDef(SA_VARNAME_SIGN_DISCLAIMER, (SEC_DIALOG_STRING_BASE + 2095), "sa_sign_disclaimer")
ResDef(SA_VARNAME_SIGN_THIS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 2096), "sa_sign_this_checkbox_label")
ResDef(SA_VARNAME_WAS_ENCRYPTED, (SEC_DIALOG_STRING_BASE + 2097), "sa_was_encrypted")
ResDef(SA_VARNAME_WAS_NOT_ENCRYPTED, (SEC_DIALOG_STRING_BASE + 2098), "sa_was_not_encrypted")
ResDef(SA_VARNAME_WAS_ENCRYPTED_FOR_OTHER_1, (SEC_DIALOG_STRING_BASE + 2099), "sa_was_encrypted_for_other_1")
ResDef(SA_VARNAME_WAS_ENCRYPTED_FOR_OTHER_2, (SEC_DIALOG_STRING_BASE + 2100), "sa_was_encrypted_for_other_2")
ResDef(SA_VARNAME_ENCRYPTION_ALGORITHM_WAS, (SEC_DIALOG_STRING_BASE + 2101), "sa_encryption_algorithm_was")
ResDef(SA_VARNAME_WAS_SIGNED_HEAD, (SEC_DIALOG_STRING_BASE + 2102), "sa_was_signed_head")
ResDef(SA_VARNAME_INCLUDED_CERT_DESC_HEAD, (SEC_DIALOG_STRING_BASE + 2103), "sa_included_cert_desc_head")
ResDef(SA_VARNAME_WAS_SIGNED_AT, (SEC_DIALOG_STRING_BASE + 2104), "sa_was_signed_at")
ResDef(SA_VARNAME_INCLUDED_CERT_DESC_SIGNED_AT, (SEC_DIALOG_STRING_BASE + 2105), "sa_included_cert_desc_signed_at")
ResDef(SA_VARNAME_WAS_SIGNED_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 2106), "sa_was_signed_desc_tail_1")
ResDef(SA_VARNAME_WAS_SIGNED_DESC_TAIL_2, (SEC_DIALOG_STRING_BASE + 2107), "sa_was_signed_desc_tail_2")
ResDef(SA_VARNAME_WAS_NOT_SIGNED, (SEC_DIALOG_STRING_BASE + 2108), "sa_was_not_signed")
ResDef(SA_VARNAME_SIG_INVALID, (SEC_DIALOG_STRING_BASE + 2109), "sa_sig_invalid")
ResDef(SA_VARNAME_ENCRYPTION_INVALID, (SEC_DIALOG_STRING_BASE + 2110), "sa_encryption_invalid")
ResDef(SA_VARNAME_SIGN_ERROR_INTRO, (SEC_DIALOG_STRING_BASE + 2111), "sa_sign_error_intro")
ResDef(SA_VARNAME_SIG_TAMPERED_1, (SEC_DIALOG_STRING_BASE + 2112), "sa_sig_tampered_1")
ResDef(SA_VARNAME_SIG_TAMPERED_2, (SEC_DIALOG_STRING_BASE + 2113), "sa_sig_tampered_2")
ResDef(SA_VARNAME_ADDR_MISMATCH_PART1, (SEC_DIALOG_STRING_BASE + 2114), "sa_addr_mismatch_part1")
ResDef(SA_VARNAME_ADDR_MISMATCH_PART2, (SEC_DIALOG_STRING_BASE + 2115), "sa_addr_mismatch_part2")
ResDef(SA_VARNAME_ADDR_MISMATCH_PART3, (SEC_DIALOG_STRING_BASE + 2116), "sa_addr_mismatch_part3")
ResDef(SA_VARNAME_NEWS_ENCRYPT_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2117), "sa_news_encrypt_subtitle")
ResDef(SA_VARNAME_NEWS_ENCRYPTED_1, (SEC_DIALOG_STRING_BASE + 2118), "sa_news_encrypted_1")
ResDef(SA_VARNAME_NEWS_ENCRYPTED_2, (SEC_DIALOG_STRING_BASE + 2119), "sa_news_encrypted_2")
ResDef(SA_VARNAME_NEWS_NOT_ENCRYPTED, (SEC_DIALOG_STRING_BASE + 2120), "sa_news_not_encrypted")
ResDef(SA_VARNAME_NAV_ENCRYPTION_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2121), "sa_nav_encryption_subtitle")
ResDef(SA_VARNAME_NAV_VERIFICATION_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2122), "sa_nav_verification_subtitle")
ResDef(SA_VARNAME_NAV_NO_ENCRYPT_DESC_1, (SEC_DIALOG_STRING_BASE + 2123), "sa_nav_no_encrypt_desc_1")
ResDef(SA_VARNAME_NAV_NO_ENCRYPT_DESC_2, (SEC_DIALOG_STRING_BASE + 2124), "sa_nav_no_encrypt_desc_2")
ResDef(SA_VARNAME_NAV_ENCRYPT_DESC_1, (SEC_DIALOG_STRING_BASE + 2125), "sa_nav_encrypt_desc_1")
ResDef(SA_VARNAME_NAV_ENCRYPT_DESC_2, (SEC_DIALOG_STRING_BASE + 2126), "sa_nav_encrypt_desc_2")
ResDef(SA_VARNAME_NAV_ENCRYPT_DESC_3, (SEC_DIALOG_STRING_BASE + 2127), "sa_nav_encrypt_desc_3")
ResDef(SA_VARNAME_NAV_NO_ENCRYPT_MIX_DESC_1, (SEC_DIALOG_STRING_BASE + 2128), "sa_nav_no_encrypt_mix_desc_1")
ResDef(SA_VARNAME_NAV_NO_ENCRYPT_MIX_DESC_2, (SEC_DIALOG_STRING_BASE + 2129), "sa_nav_no_encrypt_mix_desc_2")
ResDef(SA_VARNAME_NAV_NO_ENCRYPT_MIX_DESC_3, (SEC_DIALOG_STRING_BASE + 2130), "sa_nav_no_encrypt_mix_desc_3")
ResDef(SA_VARNAME_NAV_ENCRYPT_MIX_DESC_1, (SEC_DIALOG_STRING_BASE + 2131), "sa_nav_encrypt_mix_desc_1")
ResDef(SA_VARNAME_NAV_ENCRYPT_MIX_DESC_2, (SEC_DIALOG_STRING_BASE + 2132), "sa_nav_encrypt_mix_desc_2")
ResDef(SA_VARNAME_NAV_ENCRYPT_MIX_DESC_3, (SEC_DIALOG_STRING_BASE + 2133), "sa_nav_encrypt_mix_desc_3")
ResDef(SA_VARNAME_NAV_ENCRYPT_MIX_DESC_4, (SEC_DIALOG_STRING_BASE + 2134), "sa_nav_encrypt_mix_desc_4")
ResDef(SA_VARNAME_NAV_ENCRYPT_MIX_DESC_5, (SEC_DIALOG_STRING_BASE + 2135), "sa_nav_encrypt_mix_desc_5")
ResDef(SA_VARNAME_NAV_VERIFY_CERT_DESC, (SEC_DIALOG_STRING_BASE + 2136), "sa_nav_verify_cert_desc")
ResDef(SA_VARNAME_NAV_VERIFY_DOMAIN_DESC, (SEC_DIALOG_STRING_BASE + 2137), "sa_nav_verify_domain_desc")
ResDef(SA_VARNAME_NAV_VERIFY_MISSING_DESC_1, (SEC_DIALOG_STRING_BASE + 2138), "sa_nav_verify_missing_desc_1")
ResDef(SA_VARNAME_NAV_VERIFY_MISSING_DESC_2, (SEC_DIALOG_STRING_BASE + 2139), "sa_nav_verify_missing_desc_2")
ResDef(SA_VARNAME_NAV_INFO_MENUBAR_NAME, (SEC_DIALOG_STRING_BASE + 2140), "sa_nav_info_menubar_name")
ResDef(SA_VARNAME_NAV_INFO_TOOLBAR_NAME, (SEC_DIALOG_STRING_BASE + 2141), "sa_nav_info_toolbar_name")
ResDef(SA_VARNAME_NAV_INFO_PERSONALBAR_NAME, (SEC_DIALOG_STRING_BASE + 2142), "sa_nav_info_personalbar_name")
ResDef(SA_VARNAME_NAV_INFO_LOCATION_NAME, (SEC_DIALOG_STRING_BASE + 2143), "sa_nav_info_location_name")
ResDef(SA_VARNAME_NAV_INFO_STATUS_NAME, (SEC_DIALOG_STRING_BASE + 2144), "sa_nav_info_status_name")
ResDef(SA_VARNAME_NAV_VERIFY_JAVA_DESC_1, (SEC_DIALOG_STRING_BASE + 2145), "sa_nav_verify_java_desc_1")
ResDef(SA_VARNAME_NAV_VERIFY_JAVA_DESC_2, (SEC_DIALOG_STRING_BASE + 2146), "sa_nav_verify_java_desc_2")
ResDef(SA_VARNAME_NAV_VERIFY_JS_DESC_1, (SEC_DIALOG_STRING_BASE + 2147), "sa_nav_verify_js_desc_1")
ResDef(SA_VARNAME_NAV_VERIFY_JS_DESC_2, (SEC_DIALOG_STRING_BASE + 2148), "sa_nav_verify_js_desc_2")
ResDef(SA_VARNAME_NOT_ME_SUBTITLE, (SEC_DIALOG_STRING_BASE + 2149), "sa_not_me_subtitle")
ResDef(SA_VARNAME_NOT_ME_DESC_1, (SEC_DIALOG_STRING_BASE + 2150), "sa_not_me_desc_1")
ResDef(SA_VARNAME_NOT_ME_DESC_2, (SEC_DIALOG_STRING_BASE + 2151), "sa_not_me_desc_2")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_1, (SEC_DIALOG_STRING_BASE + 2152), "sa_certs_intro_string_1")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_2, (SEC_DIALOG_STRING_BASE + 2153), "sa_certs_intro_string_2")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_3, (SEC_DIALOG_STRING_BASE + 2154), "sa_certs_intro_string_3")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_4, (SEC_DIALOG_STRING_BASE + 2155), "sa_certs_intro_string_4")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_5, (SEC_DIALOG_STRING_BASE + 2156), "sa_certs_intro_string_5")
ResDef(SA_VARNAME_CERTS_INTRO_STRING_6, (SEC_DIALOG_STRING_BASE + 2157), "sa_certs_intro_string_6")
ResDef(SA_VARNAME_YOUR_CERTS_DESC_1, (SEC_DIALOG_STRING_BASE + 2158), "sa_your_certs_desc_1")
ResDef(SA_VARNAME_YOUR_CERTS_DESC_2, (SEC_DIALOG_STRING_BASE + 2159), "sa_your_certs_desc_2")
ResDef(SA_VARNAME_YOUR_CERTS_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 2160), "sa_your_certs_desc_tail_1")
ResDef(SA_VARNAME_YOUR_CERTS_DESC_TAIL_2, (SEC_DIALOG_STRING_BASE + 2161), "sa_your_certs_desc_tail_2")
ResDef(SA_VARNAME_PEOPLE_CERTS_DESC_1, (SEC_DIALOG_STRING_BASE + 2162), "sa_people_certs_desc_1")
ResDef(SA_VARNAME_PEOPLE_CERTS_DESC_2, (SEC_DIALOG_STRING_BASE + 2163), "sa_people_certs_desc_2")
ResDef(SA_VARNAME_GET_CERTS_DESC, (SEC_DIALOG_STRING_BASE + 2164), "sa_get_certs_desc")
ResDef(SA_VARNAME_SITE_CERTS_DESC, (SEC_DIALOG_STRING_BASE + 2165), "sa_site_certs_desc")
ResDef(SA_VARNAME_SIGNERS_CERTS_DESC, (SEC_DIALOG_STRING_BASE + 2166), "sa_signers_certs_desc")
ResDef(SA_VARNAME_SSL_DESC, (SEC_DIALOG_STRING_BASE + 2167), "sa_ssl_desc")
ResDef(SA_VARNAME_SMIME_DESC, (SEC_DIALOG_STRING_BASE + 2168), "sa_smime_desc")
ResDef(SA_VARNAME_SMIME_PREF_DESC, (SEC_DIALOG_STRING_BASE + 2169), "sa_smime_pref_desc")
ResDef(SA_VARNAME_ENCRYPT_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 2170), "sa_encrypt_always_checkbox_label")
ResDef(SA_VARNAME_SIGN_MAIL_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 2171), "sa_sign_mail_always_checkbox_label")
ResDef(SA_VARNAME_SIGN_NEWS_ALWAYS_CHECKBOX_LABEL, (SEC_DIALOG_STRING_BASE + 2172), "sa_sign_news_always_checkbox_label")
ResDef(SA_VARNAME_SMIME_CERT_DESC, (SEC_DIALOG_STRING_BASE + 2173), "sa_smime_cert_desc")
ResDef(SA_VARNAME_SMIME_SEND_CERT_DESC, (SEC_DIALOG_STRING_BASE + 2174), "sa_smime_send_cert_desc")
ResDef(SA_VARNAME_SMIME_NO_CERT_DESC_1, (SEC_DIALOG_STRING_BASE + 2175), "sa_smime_no_cert_desc_1")
ResDef(SA_VARNAME_SMIME_NO_CERT_DESC_2, (SEC_DIALOG_STRING_BASE + 2176), "sa_smime_no_cert_desc_2")
ResDef(SA_VARNAME_SMIME_CIPHER_HEADING, (SEC_DIALOG_STRING_BASE + 2177), "sa_smime_cipher_heading")
ResDef(SA_VARNAME_SMIME_CIPHER_DESC, (SEC_DIALOG_STRING_BASE + 2178), "sa_smime_cipher_desc")
ResDef(SA_VARNAME_APPLETS_DESC_1, (SEC_DIALOG_STRING_BASE + 2179), "sa_applets_desc_1")
ResDef(SA_VARNAME_APPLETS_DESC_2, (SEC_DIALOG_STRING_BASE + 2180), "sa_applets_desc_2")
ResDef(SA_VARNAME_PASSWORD_DESC_1, (SEC_DIALOG_STRING_BASE + 2181), "sa_password_desc_1")
ResDef(SA_VARNAME_PASSWORD_DESC_2, (SEC_DIALOG_STRING_BASE + 2182), "sa_password_desc_2")
ResDef(SA_VARNAME_MODULES_DESC, (SEC_DIALOG_STRING_BASE + 2183), "sa_modules_desc")
ResDef(SA_VARNAME_VIEW_CRL_BUTTON_LABEL, (SEC_DIALOG_STRING_BASE + 2184), "sa_view_crl_button_label")
ResDef(SA_VARNAME_SIGNERS_VIEW_CRL_DESC, (SEC_DIALOG_STRING_BASE + 2185), "sa_signers_view_crl_desc")
ResDef(SA_VARNAME_WAS_SIGNED_ALT_DESC_TAIL_1, (SEC_DIALOG_STRING_BASE + 2186), "sa_was_signed_alt_desc_tail_1")
ResDef(SA_VARNAME_PROXY_CERT_LABEL, (SEC_DIALOG_STRING_BASE + 2187), "sa_proxy_cert_label")
ResDef(SA_VARNAME_NO_PROXY_AUTH_LABEL, (SEC_DIALOG_STRING_BASE + 2188), "sa_no_proxy_auth_label")
ResDef(SA_VARNAMES_END, (SEC_DIALOG_STRING_BASE + 2189), "")

/* Fortezza SMIME strings */
ResDef(XP_SMIME_SKIPJACK, (SEC_DIALOG_STRING_BASE + 2500), "\
FORTEZZA SKIPJACK encryption with an 80-bit key")

/* New Security Advisor->Crypto Modules->Edit menu */
ResDef(XP_DIALOG_EDIT_MODULE, (SEC_DIALOG_STRING_BASE + 2511), "\
...
ResDef(XP_DIALOG_EDIT_MODULE_5, (SEC_DIALOG_STRING_BASE + 2517), "\
</td></tr></table></center><script>\
var login_status = %11%\
function setpass(select){%-cont-%")

ResDef(XP_DIALOG_EDIT_MODULE_6, (SEC_DIALOG_STRING_BASE + 2518), "\
...
ResDef(XP_DIALOG_EDIT_MODULE_7, (SEC_DIALOG_STRING_BASE + 2519), "\
...
ResDef(XP_DIALOG_EDIT_MODULE_8, (SEC_DIALOG_STRING_BASE + 2520), "\
  for ( var i = 0; i < numargs; i++ ) {\
    a[i] = initarray.arguments[i];\
  } return a;\
 }</script>")
 
ResDef(XP_SEC_CONFIG, (SEC_DIALOG_STRING_BASE + 2531), "\
 Config")
 
 /* Config Slot/Token */
 
ResDef(XP_DIALOG_CONFIG_SLOT, (SEC_DIALOG_STRING_BASE + 2542), "\
 <P><B>Module Name:</B> %0%\
...
ResDef(XP_DIALOG_CONFIG_SLOT_0, (SEC_DIALOG_STRING_BASE + 2543), "\
 <P>\
 <DT><INPUT TYPE=Radio %4% NAME=\042enabledisable\042 VALUE=\042disable\042> <B>\
 Disable this token. </B>\
 %-cont-%")
 
ResDef(XP_DIALOG_CONFIG_SLOT_1, (SEC_DIALOG_STRING_BASE + 2544), "\
 <FORM><P>\
 <DL>\
...
ResDef(XP_DIALOG_CONFIG_SLOT_NO_SLOT, (SEC_DIALOG_STRING_BASE + 2555), "\
 <P><B>Module Name:</B> %0%\
 <BR><B>Slot Description:</B> %1%\
 <BR><B>Token Name: </B> %2%\
 <P><HR>\
...
ResDef(XP_DIALOG_CONFIG_SLOT_NO_SLOT_0, (SEC_DIALOG_STRING_BASE + 2556), "\
 <FORM> <P>\
 <FONT COLOR=\042FF0000\042 SIZE=+1> %3%<BR>%4%<BR>%5%\
 </FONT></FORM>")
 
ResDef(XP_DIALOG_CONFIG_SLOT_TITLE, (SEC_DIALOG_STRING_BASE + 2557), "\
 Configure Slot")

/* define prompts for lm_pkcs11.c */
/* squeezed in this space */
ResDef(XP_JS_PKCS11_MOD_PROMPT, (SEC_DIALOG_STRING_BASE + 2568), "Module Name: ")
ResDef(XP_JS_PKCS11_DLL_PROMPT, (SEC_DIALOG_STRING_BASE + 2569), "File: ")


/* some Mechanism Type labels */
ResDef(XP_CKM_RSA_PKCS_LABEL, (SEC_DIALOG_STRING_BASE + 2570),\
        "RSA PKCS encryption")
 
 
/* define some messages for lm_pkcs11.c */
ResDef(XP_JS_PKCS11_EXTERNAL_DELETED, (SEC_DIALOG_STRING_BASE + 2571),
        "External security module successfully deleted")
ResDef(XP_JS_PKCS11_INTERNAL_DELETED, (SEC_DIALOG_STRING_BASE + 2572),
        "Internal security module successfully deleted")
ResDef(XP_JS_PKCS11_ADD_MOD_SUCCESS, (SEC_DIALOG_STRING_BASE + 2573),
        "A new security module has been installed")
ResDef(XP_JS_PKCS11_ADD_MOD_WARN, (SEC_DIALOG_STRING_BASE + 2574),
        "Are you sure you want to install this security module?")
ResDef(XP_JS_PKCS11_DEL_MOD_WARN, (SEC_DIALOG_STRING_BASE + 2575),
        "Are you sure you want to delete this security module?")   

ResDef(XP_SEC_PROMPT_FOR_NICKNAME, (SEC_DIALOG_STRING_BASE + 2576),
"Enter a nickname for the certificate:")

 /* Security Advisor->Signers->CRL's */

ResDef(XP_DIALOG_SHOW_CRLS_TITLE, (SEC_DIALOG_STRING_BASE + 2587), "\
View/Edit CRL's")

ResDef(XP_DIALOG_SHOW_CRL, (SEC_DIALOG_STRING_BASE + 2588), "\
...
ResDef(XP_DIALOG_NEW_CRL, (SEC_DIALOG_STRING_BASE + 2589), "\
Enter the URL of the new CRL/CKL to load:")

ResDef(XP_DIALOG_EDIT_CRL, (SEC_DIALOG_STRING_BASE + 2590), "\
<h3 align=center>%0%</h3>\
Enter the URL of the Certificate Revocation List.<br><br>\
<b>URL:</b><input name=url size=70 type=text value=\042%1%\042>")

ResDef(XP_DIALOG_NO_CRL_SELECTED, (SEC_DIALOG_STRING_BASE + 2591), "\
No CRL was selected. Please select a CRL from the list.")

ResDef(XP_DIALOG_NO_URL_FOR_CRL, (SEC_DIALOG_STRING_BASE + 2592), "\
Selected CRL does not have a valid URL to load from.\n\
Use 'New/Edit...' to set the URL.")

ResDef(XP_DIALOG_CRL_EXPIRED_TAG, (SEC_DIALOG_STRING_BASE + 2593), "\
<font color=red>Expired</font>")

ResDef(XP_DIALOG_NO_URL_GIVEN, (SEC_DIALOG_STRING_BASE + 2594), "\
You did not enter a URL: No new CRL loaded.")

ResDef(XP_DIALOG_CRL_EDIT_TITLE, (SEC_DIALOG_STRING_BASE + 2595), "\
Edit CRL")

ResDef(XP_DIALOG_CRLS_TITLE, (SEC_DIALOG_STRING_BASE + 2596), "\
CRL")

ResDef(XP_DIALOG_CRL_NOT_YET_VALID_TAG, (SEC_DIALOG_STRING_BASE + 2597), "\
...
the Navigator menu and opening the Navigator section.")
#else
ResDef(SSL_ERROR_SSL2_DISABLED,		(SSL_ERROR_BASE + 14),
"This site only supports SSL version 2.  You can enable\n\
support for SSL version 2 by selecting Security Info from\n\
...
Security Info from the Navigator menu and opening the\n\
Navigator section.")
#else
ResDef(SSL_ERROR_SSL_DISABLED,		(SSL_ERROR_BASE + 20),
"You cannot connect to an encrypted website because SSL\n\
...
"Before viewing all discussion groups, Netscape saves\n\
...
#ifdef OSF1 /* take care of long vs int */
...
ResDef (MK_ADDR_UNABLE_TO_IMPORT, XP_MSG_BASE + 987,
	"Navigator is unable to import this file into the address book.")
#else
ResDef (MK_ADDR_UNABLE_TO_IMPORT, XP_MSG_BASE + 987,
...
ResDef( XP_IMAP_SELECTING_MAILBOX, XP_MSG_BASE + 1116, "Opening mailbox %s...")

#ifdef MOZ_LITE
ResDef(MK_MSG_CONFIRM_MOVE_MAGIC_FOLDER, XP_MSG_BASE + 1117,
"Are you sure you want to move %s away from its default \n\
location? Next time Navigator runs, a new %s folder \n\
...
/* JavaScript dialog strings */

ResDef(XP_MSG_JS_CLOSE_WINDOW, XP_MSG_BASE + 1323, "Close Window?")

ResDef(XP_MSG_JS_CLOSE_WINDOW_NAME, XP_MSG_BASE + 1324, "Close Window %s?")
...
ResDef(XP_RL_ABOUT_RL, XP_MSG_BASE + 1325, "About Related Sites") 

ResDef(XP_RL_ENHANCED_LIST, XP_MSG_BASE + 1326, "Detailed List...") 


ResDef(XP_RL_FETCHING, XP_MSG_BASE + 1327, "Fetching Related Sites...") 

ResDef(XP_RL_UNAVAILABLE, XP_MSG_BASE + 1328, "No Related Sites Available")

ResDef(XP_RL_DISABLED, XP_MSG_BASE + 1329, "Related Sites Disabled")

ResDef(XP_MSG_IMAP_LOGIN_FAILED, XP_MSG_BASE + 1330, "Login failed.")

ResDef(XP_MSG_CACHED_PASSWORD_NOT_MATCHED, XP_MSG_BASE + 1331, "Password entered doesn't match last password used with server.")

ResDef(XP_MSG_PASSWORD_FAILED_CLOSE_WINDOW, XP_MSG_BASE + 1332, "You have not entered a password or have exceeded the number of \
password attempts allowed. This window will be closed.")
