...
// there is a focus event which gets fired and calls this function.
...
function appendTableRes()
{
  ...
  for(var i=0; i<row.length; i++)
  {
    ...
    else
    {
      ...
      {
        if(temprow[j] == "FAIL")
          res += "<td bgcolor='#FF0000'>" + temprow[j] + "</td>";
        else
          res += "<td>" + temprow[j] + "</td>";
       }
     }
...
// This function will test the attribute accKeyboardShortcut.
